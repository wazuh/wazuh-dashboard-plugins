...
export function TableHeaderColumn({
  ...
  const getSortButtonAriaLabel = () => {
    const sortAscendingMessage = i18n.translate(
      'wazuh.discover.docTable.tableHeader.sortByColumnAscendingAriaLabel',
      {
    ...
    const sortDescendingMessage = i18n.translate(
      'wazuh.discover.docTable.tableHeader.sortByColumnDescendingAriaLabel',
      {
    ...
    const stopSortingMessage = i18n.translate(
      'wazuh.discover.docTable.tableHeader.sortByColumnUnsortedAriaLabel',
      {
  ...
  const buttons = [
    ...
    // Remove Button
    {
      ...
      ariaLabel: i18n.translate('wazuh.discover.docTable.tableHeader.removeColumnButtonAriaLabel', {
      ...
      tooltip: i18n.translate('wazuh.discover.docTable.tableHeader.removeColumnButtonTooltip', {
    ...
    // Move Left Button
    {
      ...
      ariaLabel: i18n.translate('wazuh.discover.docTable.tableHeader.moveColumnLeftButtonAriaLabel', {
      ...
      tooltip: i18n.translate('wazuh.discover.docTable.tableHeader.moveColumnLeftButtonTooltip', {
    ...
    // Move Right Button
    {
      ...
      ariaLabel: i18n.translate('wazuh.discover.docTable.tableHeader.moveColumnRightButtonAriaLabel', {
      ...
      tooltip: i18n.translate('wazuh.discover.docTable.tableHeader.moveColumnRightButtonTooltip', {
