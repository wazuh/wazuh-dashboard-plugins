...
export function DocViewTableRowIconUnderscore() {
  const ariaLabel = i18n.translate(
    'wazuh.discover.docViews.table.fieldNamesBeginningWithUnderscoreUnsupportedAriaLabel',
    {
      defaultMessage: 'Warning',
    }
  );
  const tooltipContent = i18n.translate(
    'wazuh.discover.docViews.table.fieldNamesBeginningWithUnderscoreUnsupportedTooltip',
    {
