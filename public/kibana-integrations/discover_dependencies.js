...
import { createToolBarPagerButtonsDirective, createToolBarPagerTextDirective, } from 'plugins/kibana/discover/np_ready/angular/doc_table/components/pager';
...
app.factory('pagerFactory', createPagerFactory)
