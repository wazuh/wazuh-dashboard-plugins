...
const name2 = i18n.translate(
  'wazuh.controller.manage.comp.confi.setting.name2',
  {
    defaultMessage: 'Users',
  },
);
const name3 = i18n.translate(
  'wazuh.controller.manage.comp.confi.setting.name3',
  {
    defaultMessage: 'Roles',
  },
);
const name4 = i18n.translate(
  'wazuh.controller.manage.comp.confi.setting.name4',
  {
    defaultMessage: 'Policies',
  },
);
const name5 = i18n.translate(
  'wazuh.controller.manage.comp.confi.setting.name5',
  {
