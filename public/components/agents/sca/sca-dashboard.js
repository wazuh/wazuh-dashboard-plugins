  ...
  render() {
    ...
    return (
      <div>
        ...
        {this.state.agent &&
          (this.state.agent || {}).status !== 'Never connected' &&
              ...
              <EuiPage>
                <EuiPanel paddingSize="l">
                        ...
                        <h2>
                          ...
                          >
                            <EuiButtonIcon
                              ...
                              onClick={() =>
                                this.setState({
                                  showChecksum: !this.state.showChecksum
                                })
                              }
                            />
                          </EuiToolTip>
                  ...
                  <EuiFlexGroup>
                    <EuiFlexItem>
                      <EuiStat
                        title={this.state.lookingPolicy.pass}
                        description="Pass"
                    ...
                    <EuiFlexItem>
                      <EuiStat
                        title={this.state.lookingPolicy.fail}
                        description="Fail"
                        titleColor="danger"
                        titleSize="m"
                        textAlign="center"
                    ...
                    <EuiFlexItem>
                      <EuiStat
                        title={this.state.lookingPolicy.invalid}
                    ...
                    <EuiFlexItem>
                      <EuiStat
                        title={this.state.lookingPolicy.end_scan}
