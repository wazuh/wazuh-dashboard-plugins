...
const name1 = i18n.translate(
  'wazuh.components.agents.vuls.inventory.details.name1',
  {
    defaultMessage: 'Title',
  },
);
const name2 = i18n.translate(
  'wazuh.components.agents.vuls.inventory.details.name2',
  {
    defaultMessage: 'Name',
  },
);
const name3 = i18n.translate(
  'wazuh.components.agents.vuls.inventory.details.name3',
  {
    defaultMessage: 'CVE',
  },
);
const name4 = i18n.translate(
  'wazuh.components.agents.vuls.inventory.details.name4',
  {
    defaultMessage: 'Version',
  },
);
const name5 = i18n.translate(
  'wazuh.components.agents.vuls.inventory.details.name5',
  {
    defaultMessage: 'Architecture',
  },
);
const name6 = i18n.translate(
  'wazuh.components.agents.vuls.inventory.details.name6',
  {
    defaultMessage: 'Condition',
  },
);
const name7 = i18n.translate(
  'wazuh.components.agents.vuls.inventory.details.name7',
  {
    defaultMessage: 'Last full scan',
  },
);
const name8 = i18n.translate(
  'wazuh.components.agents.vuls.inventory.details.name8',
  {
    defaultMessage: 'Last partial scan',
  },
);
const name9 = i18n.translate(
  'wazuh.components.agents.vuls.inventory.details.name9',
  {
    defaultMessage: 'Published',
  },
);
const name10 = i18n.translate(
  'wazuh.components.agents.vuls.inventory.details.name10',
  {
    defaultMessage: 'Updated',
  },
);
const name11 = i18n.translate(
  'wazuh.components.agents.vuls.inventory.details.name11',
  {
    defaultMessage: 'References',
  },
);
const label1 = i18n.translate(
  'wazuh.components.agents.vuls.inventory.details.label1',
  {
    defaultMessage: 'Agent',
  },
);
const label2 = i18n.translate(
  'wazuh.components.agents.vuls.inventory.details.label2',
  {
    defaultMessage: 'Agent name',
  },
);
const label3 = i18n.translate(
  'wazuh.components.agents.vuls.inventory.details.label3',
  {
    defaultMessage: 'Description',
  },
);
const label4 = i18n.translate(
  'wazuh.components.agents.vuls.inventory.details.label4',
  {
    defaultMessage: 'Level',
  },
);
const label5 = i18n.translate(
  'wazuh.components.agents.vuls.inventory.details.label5',
  {
    defaultMessage: 'Rule ID',
  },
);
const label6 = i18n.translate(
  'wazuh.components.agents.vuls.inventory.details.label6',
  {
        ...
        <EuiAccordion
          ...
          buttonContent={
            <EuiTitle size='s'>
              <h3>
                {i18n.translate(
                  'wazuh.components.agent.fim.ivv.lib.recevents',
                  {
