  ...
  class WzMenu extends Component {
    ...
    async componentDidUpdate(prevProps) {
      ...
      if (
        ...
        this.props.state.indexPatterns !== prevProps.state.indexPatterns
      ) {
        this.load();
      }
          ...
          <EuiToolTip position="top" content={this.formatAgentStatus(agent.status)}>
            <span className="euiFlexItem euiFlexItem--flexGrowZero">
              <svg
                ...
                className={`euiIcon euiIcon--medium euiIcon--${this.color(agent.status)}`}
                focusable="false"
                role="img"
                aria-hidden="true"
              >
    ...
    render() {
          ...
          <div className="wz-menu-left-side">
            <div className="wz-menu-sections" style={!thereAreSelectors ? { height: '100%' } : {}}>
              <EuiButtonEmpty
                ...
                className={
                  'wz-menu-button ' +
                  ((this.state.currentMenuTab === 'overview' && !this.isAnyPopoverOpen()) ||
                  this.state.isOverviewPopoverOpen
                    ? 'wz-menu-active'
                    : '')
                }
              ...
              <EuiButtonEmpty
                ...
                className={
                  'wz-menu-button ' +
                  ((this.state.currentMenuTab === 'manager' && !this.isAnyPopoverOpen()) ||
                  this.state.isManagementPopoverOpen
                    ? 'wz-menu-active'
                    : '')
                }
              ...
              >
                ...
                <span className="flex"></span>
                {this.state.isToolsPopoverOpen && <EuiIcon color="subdued" type="arrowRight" />}
              </EuiButtonEmpty>
              ...
              <EuiButtonEmpty
                ...
                className={
                  'wz-menu-button ' +
                  ((this.state.currentMenuTab === 'security' && !this.isAnyPopoverOpen()) ||
                  this.state.isSecurityPopoverOpen
                    ? 'wz-menu-active'
                    : '')
                }
              ...
              >
                ...
                <span className="flex"></span>
                {this.state.isSecurityPopoverOpen && <EuiIcon color="subdued" type="arrowRight" />}
              </EuiButtonEmpty>
              <EuiButtonEmpty
                data-test-subj="menuSettingsButton"
                className={
                  'wz-menu-button ' +
                  ((this.state.currentMenuTab === 'settings' && !this.isAnyPopoverOpen()) ||
                  this.state.isSettingsPopoverOpen
                    ? 'wz-menu-active'
                    : '')
                }
              ...
              >
                ...
                <span className="flex"></span>
                {this.state.isSettingsPopoverOpen && <EuiIcon color="subdued" type="arrowRight" />}
              </EuiButtonEmpty>
            </div>
          </div>
      ...
      const logotype_url = getHttp().basePath.prepend(
        `/plugins/wazuh/assets/${this.wazuhConfig.getConfig()['customization.logo.app']}`
      );
      const mainButton = (
        <button
        ...
        >
          <EuiFlexGroup direction="row" responsive={false} style={{ paddingTop: 2 }}>
            <EuiFlexItem grow={false} style={{ marginRight: 0 }}>
              <img src={logotype_url} className="navBarLogo" alt=""></img>
            </EuiFlexItem>
            <EuiFlexItem grow={false} style={{ margin: '12px 6px' }}>
              {this.state.menuOpened && <EuiIcon color="subdued" type="arrowUp" size="l" />}
              {!this.state.menuOpened && <EuiIcon color="subdued" type="arrowDown" size="l" />}
            </EuiFlexItem>
          </EuiFlexGroup>
        </button>
      );
