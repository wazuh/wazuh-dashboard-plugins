...
const apiTitle =  i18n.translate('wazuh.components.healthCheck.apiCheck', { defaultMessage: 'Check Wazuh API connection', })
const apiLabel =  i18n.translate('wazuh.components.healthCheck.apiConnection', { defaultMessage: 'API connection', })
const setupTitle =  i18n.translate('wazuh.components.healthCheck.checkApiVersion', { defaultMessage: 'Check Wazuh API version', })
const setupLabel =  i18n.translate('wazuh.components.healthCheck.apiVersion', { defaultMessage: 'API version', })
const patternTitle =  i18n.translate('wazuh.components.healthCheck.checkAlert', { defaultMessage: 'Check alerts index pattern', })
const patternLabel =  i18n.translate('wazuh.components.healthCheck.alertPattern', { defaultMessage: 'Alerts index pattern', })
const patternMonitoringTitle =  i18n.translate('wazuh.components.healthCheck.checkMonitoring', { defaultMessage: 'Check monitoring index pattern', })
const patternMonitoringLabel =  i18n.translate('wazuh.components.healthCheck.monitorPattern', { defaultMessage: 'Monitoring index pattern', })
const patternStatisticsTitle =  i18n.translate('wazuh.components.healthCheck.checkStat', { defaultMessage: 'Check statistics index pattern', })
const patternStatisticsLabel =  i18n.translate('wazuh.components.healthCheck.statPattern', { defaultMessage: 'Statistics index pattern', })
const checks = {
	api: {
		title: apiTitle,
		label: apiLabel,
						...
						{isDebugMode && Object.keys(checks).every(check => checksReady[check]) && (
							<EuiFlexItem grow={false}>
								<EuiButton fill onClick={redirectionPassHealthcheck}>
									{
										i18n.translate("wazuh.components.health.continer.Continue", {
