...
export const AgentsWelcome = compose(
  ...
  class AgentsWelcome extends Component {
    ...
    updateMenuAgents() {
      const securityEvents = i18n.translate('components.welcome.agentWelcome.securityEvent', {
      ...
      const sca = i18n.translate('components.welcome.agentWelcome.sca', {
        defaultMessage: 'SCA',
      });
      ...
      const vulnerability = i18n.translate('components.welcome.agentWelcome.vulnerability', {
        defaultMessage: 'Vulnerabilities',
      });
      const mitre = i18n.translate('components.welcome.agentWelcome.mitre', {
                  ...
                  <EuiButtonEmpty
                    onClick={() => {
                      window.location.href = `#/overview/?tab=${
                        ...
                        menuAgent.text === i18n.translate('components.welcome.agentWelcome.securityConfigurationAssessment', {
          ...
          <EuiFlexItem grow={false} style={{ marginTop: 7 }}>
            <EuiPopover
              button={
                ...
                >
                  {
                    i18n.translate('components.welcome.agentWelcome.moreLabel', {
                      defaultMessage: 'More...',
                    })
                  }
                </EuiButtonEmpty>
    ...
    getOptions() {
      ...
      const gdpr = i18n.translate('components.welcome.agentWelcome.options.gdpr', {
        defaultMessage: 'GDPR',
      });
      ...
      const hipaa = i18n.translate('components.welcome.agentWelcome.options.hipaa', {
        defaultMessage: 'HIPAA',
      });

      const gpg13 = i18n.translate('components.welcome.agentWelcome.options.gpg13', {
        defaultMessage: 'GPG13',
      });

      const tsc = i18n.translate('components.welcome.agentWelcome.options.tsc', {
        defaultMessage: 'TSC',
      });
              ...
              <EuiFlexGroup>
                <EuiFlexItem>
                  <h2 className='embPanel__title wz-headline-title'>
                    <EuiText size='xs'>
                      <h2>
                      { i18n.translate('components.welcome.agentWelcome.mitreText', {
                ...
                <EuiFlexItem grow={false} style={{ alignSelf: 'center' }}>
                  <EuiToolTip position='top' content={
                      i18n.translate('components.welcome.agentWelcome.openMitreText', {
              ...
              <EuiFlexItem>
                <h2 className='embPanel__title wz-headline-title'>
                  <EuiText size='xs'>
                    <h2>
                    {
                      i18n.translate('components.welcome.agentWelcome.eventCountEvolution', {
        ...
        return (
          <EuiEmptyPrompt
            ...
            title={
              <h2>
                {
                  i18n.translate('components.welcome.agentWelcome.agentNeverConnected', {
            ...
            body={
              <Fragment>
                <p>
                  {
                    i18n.translate('components.welcome.agentWelcome.agentNotConnectedWithManager', {
                ...
                >
                  {
                    i18n.translate('components.welcome.agentWelcome.checkConnectionWithWazuhServer', {
            ...
            actions={
              <EuiButton href='#/agents-preview?' color='primary' fill>
                {
                  i18n.translate('components.welcome.agentWelcome.backButton', {
                    defaultMessage: 'Back',
                })}
              </EuiButton>
            }
