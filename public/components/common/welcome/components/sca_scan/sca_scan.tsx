          ...
          <EuiFlexGroup>
            <EuiFlexItem grow={false} style={{ marginTop: 15 }}>
              <EuiText>
                ...
                {i18n.translate(
                  'wazuh.components.common.welcome.components.mitreTop.startTime',
                  { defaultMessage: 'Start time:' },
                )}{' '}
                {formatUIDate(lastScan.start_scan)}
              </EuiText>
            </EuiFlexItem>
            <EuiFlexItem grow={false} style={{ marginTop: 15 }}>
              <EuiText>
                ...
                {i18n.translate(
                  'wazuh.components.common.welcome.components.mitreTop.duration',
        ...
        <Fragment>
          <EuiEmptyPrompt
            ...
            title={
              <h4>
                {i18n.translate(
                  'wazuh.components.common.welcome.components.mitreTop.SCAScans',
            ...
            body={
              <Fragment>
                <p>
                  {i18n.translate(
                    'wazuh.components.common.welcome.components.mitreTop.agentSettings',
                    {
                      defaultMessage:
            ...
            <EuiText size='xs'>
              <EuiFlexGroup>
                <EuiFlexItem>
                  <h2>
                    {i18n.translate(
                      'wazuh.components.common.welcome.components.mitreTop.lastScan',
                      { defaultMessage: 'SCA: Last scan' },
                    )}
                  </h2>
                </EuiFlexItem>
                <EuiFlexItem grow={false}>
