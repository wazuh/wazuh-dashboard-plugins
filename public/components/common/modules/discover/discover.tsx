  ...
  class Discover extends Component {
    ...
    async getIndexPattern() {
      ...
      Object.keys(this.indexPattern.fields).forEach(item => {
        if (isNaN(item)) {
          ...
          this.indexPattern.fields[item].name.includes(
            this.props.includeFilters,
          )
        ) {
    ...
    removeColumn(id) {
      if (this.state.columns.length < 2) {
        const title1 = i18n.translate(
          'wazuh.components.common.modules.oneColumnMustBeSelected',
          {
    ...
    addColumn(id) {
      if (this.state.columns.length > 11) {
        const maxNumberOfColumn = i18n.translate(
          'wazuh.components.common.modules.maxNumberOfColumn',
          {
    ...
    render() {
      ...
      const noResultsText = i18n.translate(
        'wazuh.components.common.modules.noResultsMatch',
        {
