...
const textModules = i18n.translate(
  'wazuh.components.common.module.main.module.textModules',
  {
        ...
        breadcrumb.push({
          text: (
            ...
            >
              ...
              <EuiToolTip
                content={WAZUH_MODULES[this.props.section].description}
              >
                <EuiIcon
                  style={{ margin: '0px 0px 1px 5px' }}
                  type='iInCircle'
                />
              </EuiToolTip>
            </EuiFlexGroup>
