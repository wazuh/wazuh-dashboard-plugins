...
export class WelcomeScreen extends Component {
  ...
  buildChart(){
    return(
      ...
      <EuiPanel paddingSize="none" style={{maxHeight: 300}}>
    ...
    <EuiFlexGroup>
      <EuiFlexItem>
        ...
        <EuiHorizontalRule style={{marginLeft: 15,marginTop: 8, marginBottom: -10,marginRight: 20, width: "auto"}} margin="m"/>
  ...
  buildExtraCharts(){
    ...
    return(
      ...
      <EuiFlexItem grow={false}>
        <EuiPanel>   
        <EuiTitle size="s">
          <h1><EuiIcon type="usersRolesApp" size="xl" /> &nbsp;Authentication attempts</h1>
        </EuiTitle>
        <EuiHorizontalRule margin="s"></EuiHorizontalRule>
        ...
        <EuiFlexGroup style={{marginTop: 25, minWidth: 290}}>
        <Chart  size={{height: 125, marginLeft: 5}}>
            <Settings
              showLegend={false}
              legendPosition="right"
      ...
      <EuiFlexItem grow={true}>
        <EuiPanel>   
        <EuiTitle size="s">
          <h1><EuiIcon type="securityAnalyticsApp" size="xl" /> &nbsp; Alerts summary</h1>
        </EuiTitle>
        <EuiHorizontalRule margin="s"></EuiHorizontalRule>
        ...
        <EuiFlexItem grow={false}>
          <EuiPanel>
            <EuiTitle size="s">
              <h1><EuiIcon type="monitoringApp" size="xl" /> &nbsp;Agents summary</h1>
            </EuiTitle>
            <EuiHorizontalRule margin="s"></EuiHorizontalRule>
            <EuiFlexGroup>
              <Pie customStyle={{marginLeft:100, marginRight: -30}} width={240} height={125} data={model} colors={colors} noLegend={true} />
            </EuiFlexGroup>
