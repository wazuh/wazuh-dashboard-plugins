...
import { cleanInfo, updateFileContent } from '../../../../redux/actions/rulesetActions';
...
class WzRulesetEditor extends Component {
  ...
  render() {
    ...
    const saveButton = (
      <WzButtonPermissions
        permissions={[
          { action: 'manager:upload_file', resource: `file:path:etc/${section}/${nameForSaving}` },
        ]}
        fill
    ...
    const handleBackPage = () => {
      this.props.cleanInfo();
      this.props.params.history.push(`/management/${section}`);
    };
