                ...
                <WzButtonPermissions
                  ...
                  permissions={[
                    [
                      ...
                      { action: 'rules:read', resource: `rule:file:${item.filename}` },
                    ],
                  ]}
                ...
                <WzButtonPermissions
                  ...
                  permissions={[
                    [
                      ...
                      { action: 'decoders:read', resource: `decoder:file:${item.filename}` },
                    ],
                  ]}
                  tooltip={{ position: 'top', content: `Show ${value} content` }}
                  onClick={async (ev) => {
            ...
            <div>
              ...
              <WzButtonPermissions
                ...
                tooltip={{
                  position: 'top',
                  content:
                    defaultItems.indexOf(`${item.relative_dirname}`) === -1
                      ? `Delete ${item.filename}`
                      : `The ${item.filename} list cannot be deleted`,
                }}
                onClick={async (ev) => {
                  ev.stopPropagation();
                  this.tableProps.updateListItemsForRemove([item]);
