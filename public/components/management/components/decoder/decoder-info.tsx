...
class WzDecoderInfo extends Component {
  ...
  changeBetweenDecoders(name) {
    ...
    this.props.params.history.push(`/management/decoders/${name}`);
  }
  ...
  render() {
    ...
    const handlerBackToMainDecoders = () => {
      this.props.params.history.push(`/management/decoders`);
      this.props.cleanInfo();
    };
                  ...
                  <span style={{ fontSize: '22px' }}>
                    <EuiToolTip position="right" content="Back to decoders">
                      <EuiButtonIcon
                        ...
                        iconSize="l"
                        iconType="arrowLeft"
                        onClick={handlerBackToMainDecoders}
                      />
                    </EuiToolTip>
                    {name}
                  </span>
