...
const complianceTitle1 = i18n.translate(
  'wazuh.public.components.overview.comp.table.complianceTitle1',
  {
    defaultMessage: 'Compliance',
  },
);
const complianceTitle2 = i18n.translate(
  'wazuh.public.components.overview.comp.table.complianceTitle2',
  {
    defaultMessage: 'data could not be fetched',
  },
);
const mitireTitle = i18n.translate(
  'wazuh.public.components.overview.comp.table.',
  {
      ...
      try {
        ...
        const options = {
          ...
          error: {
            ...
            title: `${complianceTitle1} (${this.props.section}) ${complianceTitle2} `,
          },
        };
