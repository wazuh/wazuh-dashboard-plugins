...
const sysCheckName = i18n.translate("components.addModule.guide.sysCheckName", {
  defaultMessage: "Integrity monitoring",
});
const sysCheckTag = i18n.translate(
  "components.addModule.guide.sysCheckTag",
  {
    defaultMessage: "sysCheck",
  }
);
const sysCheckDescp = i18n.translate(
  "components.addModule.guide.sysCheckDescp",
  {
    defaultMessage: "Configuration options for file integrity monitoring.",
  }
);
const sysCheckCate = i18n.translate("components.addModule.guide.sysCheckCate", {
...
const titleDescp = i18n.translate("components.addModule.guide.titleDescp", {
  defaultMessage:
    "Add or remove directories to be monitored. You can add multiple directories with different monitoring configurations.",
});
const directoriesName = i18n.translate("components.addModule.guide.directoriesName", {
  defaultMessage: "directories",
});
const directoriesDescp = i18n.translate("components.addModule.guide.directoriesDescp", {
...
const commaPlace = i18n.translate(
  "components.addModule.guide.commaPlace",
  {
    defaultMessage: "Any directory comma separated",
  }
);
const realtimeName = i18n.translate("components.addModule.guide.realtimeName", {
  defaultMessage: "realtime",
});
const realtimeDescp = i18n.translate("components.addModule.guide.realtimeDescp", {
...
const whoDataName = i18n.translate("components.addModule.guide.whoDataName", {
  defaultMessage: "who-data",
});
const whoDataDescp = i18n.translate("components.addModule.guide.whoDataDescp", {
  defaultMessage:
    "This will enable who-data monitoring on Linux and Windows systems.",
});

const reportName = i18n.translate("components.addModule.guide.reportName", {
  defaultMessage: "report_changes",
});
const reportDescp = i18n.translate("components.addModule.guide.reportDescp", {
  defaultMessage:
    "Report file changes. This is limited to text files at this time.",
});

const checkAllName = i18n.translate("components.addModule.guide.checkAllName", {
  defaultMessage: "check_all",
});
const checkAllDescp = i18n.translate(
  "components.addModule.guide.checkAllDescp",
  {
    defaultMessage: "All attributes with the prefix check_ will be activated.",
  }
);

const checkSumName = i18n.translate("components.addModule.guide.checkSumName", {
  defaultMessage: "check_sum",
});
const checkSumDescp = i18n.translate("components.addModule.guide.checkSumDescp", {
...
const checkMd5Name = i18n.translate("components.addModule.guide.checkMd5Name", {
  defaultMessage: "check_md5sum",
});
const checkMd5Descp = i18n.translate("components.addModule.guide.checkMd5Descp", {
  defaultMessage: "Check only the MD5 hash of the files.",
});

const check_sha256sumName = i18n.translate("components.addModule.guide.check_sha256sumName", {
  defaultMessage: "check_sha256sum",
});
const check_sha256sumDescp = i18n.translate("components.addModule.guide.check_sha256sumDescp", {
  defaultMessage: "Check only the SHA-256 hash of the files.",
});

const check_sizeName = i18n.translate("components.addModule.guide.check_sizeName", {
  defaultMessage: "check_size",
});
const check_sizeDescp = i18n.translate("components.addModule.guide.check_sizeDescp", {
  defaultMessage: "Check the size of the files.",
});

const check_ownerName = i18n.translate("components.addModule.guide.check_ownerName", {
  defaultMessage: "check_owner",
});
const check_ownerDescp = i18n.translate("components.addModule.guide.check_ownerDescp", {
  defaultMessage: "Check the owner of the files.On Windows, uid will always be 0.",
});

const check_groupName = i18n.translate("components.addModule.guide.check_groupName", {
  defaultMessage: "check_group",
});
const check_groupDescp = i18n.translate("components.addModule.guide.check_groupDescp", {
...
const check_permName = i18n.translate("components.addModule.guide.check_permName", {
  defaultMessage: "check_perm",
});
const check_permDescp = i18n.translate("components.addModule.guide.check_permDescp", {
...
const check_attrsName = i18n.translate("components.addModule.guide.check_attrsName", {
  defaultMessage: "check_attrs",
});
const check_attrsDescp = i18n.translate("components.addModule.guide.check_attrsDescp", {
  defaultMessage: "Check the attributes of the files.Available for Windows",
});

const check_mtimeName = i18n.translate("components.addModule.guide.check_mtimeName", {
  defaultMessage: "check_mtime",
});
const check_mtimeDescp = i18n.translate("components.addModule.guide.check_mtimeDescp", {
  defaultMessage: "Check the modification time of a file.",
});

const check_inodeName = i18n.translate("components.addModule.guide.check_inodeName", {
  defaultMessage: "check_inode",
});
const check_inodeDescp = i18n.translate("components.addModule.guide.check_inodeDescp", {
  defaultMessage: "Check the file inode.Available for UNIX. On Windows, inode will always be 0.",
});

const restrictName = i18n.translate("components.addModule.guide.restrictName", {
  defaultMessage: "restrict",
});
const restrictDescp = i18n.translate("components.addModule.guide.restrictDescp", {
...
const restrictPlace = i18n.translate(
  "components.addModule.guide.restrictPlace",
  {
    defaultMessage: "sregex",
  }
);
const restrictError = i18n.translate(
  "components.addModule.guide.restrictError",
  {
    defaultMessage:
      "Any directory or file name (but not a path) is allowed",
  }
);
const tagsName = i18n.translate("components.addModule.guide.tagsName", {
  defaultMessage: "tags",
});
const tagsDescp = i18n.translate("components.addModule.guide.tagsDescp", {
  defaultMessage: "Add tags to alerts for monitored directories.",
});

const recursion_levelName = i18n.translate("components.addModule.guide.recursion_levelName", {
  defaultMessage: "recursion_level",
});
const recursion_levelDescp = i18n.translate("components.addModule.guide.recursion_levelDescp", {
  defaultMessage: "Limits the maximum level of recursion allowed.",
});
const  recursion_levelPlace = i18n.translate(
  "components.addModule.guide. recursion_levelPlace",
  {
    defaultMessage: "Any integer between 0 and 320",
  }
);
const  recursion_levelError = i18n.translate(
  "components.addModule.guide. recursion_levelError",
  {
    defaultMessage:
      "Any integer between 0 and 320",
  }
);
const follow_symbolic_linkName = i18n.translate("components.addModule.guide.follow_symbolic_linkName", {
  defaultMessage: "follow_symbolic_link",
});
const follow_symbolic_linkDescp = i18n.translate("components.addModule.guide.follow_symbolic_linkDescp", {
...
const ignoreName = i18n.translate("components.addModule.guide.ignoreName", {
  defaultMessage: "ignore",
});
const ignoreDescp = i18n.translate(
  "components.addModule.guide.ignoreDescp",
  {
    defaultMessage: "File or directory to be ignored.",
  }
);
const ignorePlace = i18n.translate(
  "components.addModule.guide.ignorePlace",
  {
    defaultMessage: "File/directory path",
  }
);
const sregexName = i18n.translate("components.addModule.guide.sregexName", {
  defaultMessage: "type",
});
const sregexDescp = i18n.translate(
  "components.addModule.guide.sregexDescp",
  {
...
const sregexPlace = i18n.translate(
  "components.addModule.guide.sregexPlace",
  {
    defaultMessage: "sregex",
  }
);
const sregexDefault = i18n.translate(
  "components.addModule.guide.sregexDefault",
  {
    defaultMessage: "sregex",
  }
);
...
const title2Descp = i18n.translate("components.addModule.guide.title2Descp", {
...
const title3Descp = i18n.translate("components.addModule.guide.title3Descp", {
  defaultMessage: "Day of the week to run the scans. You can add multiple times this option.",
});
const scan_dayName = i18n.translate("components.addModule.guide.scan_dayName", {
  defaultMessage: "scan_day",
});
const scan_dayDescp = i18n.translate(
  "components.addModule.guide.scan_dayDescp",
  {
    defaultMessage: "Day of the week to run the scans.",
  }
);
const weakDaysName = i18n.translate('components.addModule.guide.weakDaysName', {
  defaultMessage: 'sunday',
});
const weakDays1Name = i18n.translate(
  'components.addModule.guide.weakDays1Name',
  {
    defaultMessage: 'monday',
  },
);
const weakDays2Name = i18n.translate(
  'components.addModule.guide.weakDays2Name',
  {
    defaultMessage: 'tuesday',
  },
);
const weakDays3Name = i18n.translate(
  'components.addModule.guide.weakDays3Name',
  {
    defaultMessage: 'wednesday',
  },
);
const weakDays4Name = i18n.translate(
  'components.addModule.guide.weakDays4Name',
  {
    defaultMessage: 'thursday',
  },
);
const weakDays5Name = i18n.translate(
  'components.addModule.guide.weakDays5Name',
  {
    defaultMessage: 'friday',
  },
);
const weakDays6Name = i18n.translate(
  'components.addModule.guide.weakDays6Name',
  {
    defaultMessage: 'saturday',
  },
);
const weakDaysDefault = i18n.translate('components.addModule.guide.weakDaysDefault', {
  defaultMessage: 'sunday',
});
const weakDaysError = i18n.translate('components.addModule.guide.weakDaysError', {
...
const winPlace = i18n.translate("components.addModule.guide.winPlace", {
  defaultMessage: "Windows registry entry",
});
const archName = i18n.translate("components.addModule.guide.archName", {
  defaultMessage: "arch",
});
const archDescp = i18n.translate(
  "components.addModule.guide.archDescp",
  {
    defaultMessage: "Select the Registry view depending on the architecture.",
  }
);
const text1 = i18n.translate(
  "components.addModule.guide.text1",
  {
    defaultMessage: "32bit",
  }
);
const text2 = i18n.translate(
  "components.addModule.guide.text2",
  {
    defaultMessage: "64bit",
  }
);
const text3 = i18n.translate(
  "components.addModule.guide.text3",
  {
    defaultMessage: "both",
  }
);
...
const tagsPlace = i18n.translate("components.addModule.guide.tagsPlace", {
  defaultMessage:
...
const title5Descp = i18n.translate("components.addModule.guide.title5Descp", {
  defaultMessage: "List of registry entries to be ignored.",
});
const registry_ignoreName = i18n.translate("components.addModule.guide.registry_ignoreName", {
  defaultMessage: "registry_ignore",
});
const registry_ignoreDescp = i18n.translate("components.addModule.guide.registry_ignoreDescp", {
  defaultMessage:
...
const registry_ignorePlace = i18n.translate("components.addModule.guide.registry_ignorePlace", {
  defaultMessage: "Any registry entry.",
});
const registry_ignoreError = i18n.translate("components.addModule.guide.registry_ignoreError", {
  defaultMessage:
    "Any registry entry.",
});
...
const frequencyName = i18n.translate("components.addModule.guide.frequencyName", {
  defaultMessage: "frequency",
});
const frequencyDescp = i18n.translate("components.addModule.guide.frequencyDescp", {
  defaultMessage:
    "Frequency that the syscheck will be run (in seconds).",
});
const frequencyPlace = i18n.translate("components.addModule.guide.frequencyPlace", {
  defaultMessage: "Time in seconds.",
});
const frequencyError = i18n.translate("components.addModule.guide.frequencyError", {
  defaultMessage:
    "A positive number, time in seconds.",
});
const scan_timeName = i18n.translate("components.addModule.guide.scan_timeName", {
  defaultMessage: "scan_time",
});
const scan_timeDescp = i18n.translate("components.addModule.guide.scan_timeDescp", {
  defaultMessage:
    "Time to run the scans. Times may be represented as 9pm or 8:30.",
});
const scan_timePlace = i18n.translate("components.addModule.guide.scan_timePlace", {
  defaultMessage: "Time of day",
});
const scan_timeInfo = i18n.translate("components.addModule.guide.scan_timeInfo", {
  defaultMessage: "This may delay the initialization of real-time scans.",
});
const scan_timeError = i18n.translate("components.addModule.guide.scan_timeError", {
  defaultMessage:
    "Time of day represented as 9pm or 8:30",
});
const scan_timeWar = i18n.translate("components.addModule.guide.scan_timeWar", {
  defaultMessage:
    "This may delay the initialization of real-time scans.",
});
const auto_ignoreName = i18n.translate("components.addModule.guide.auto_ignoreName", {
  defaultMessage: "auto_ignore",
});
const auto_ignoreDescp = i18n.translate("components.addModule.guide.auto_ignoreDescp", {
  defaultMessage:
    "Specifies whether or not syscheck will ignore files that change too many times (manager only).",
});
const auto_ignoreInfo = i18n.translate("components.addModule.guide.auto_ignoreInfo", {
  defaultMessage: "It is valid on: server and local.",
});
const frequency1Name = i18n.translate("components.addModule.guide.frequency1Name", {
  defaultMessage: "frequency",
});
const frequency1Descp = i18n.translate("components.addModule.guide.frequency1Descp", {
  defaultMessage:
    "Number of times the alert can be repeated in the 'timeframe' time interval..",
});
const frequency1Error = i18n.translate("components.addModule.guide.frequency1Error", {
  defaultMessage:
    "Any number between 1 and 99.",
});
const timeframeName = i18n.translate("components.addModule.guide.timeframeName", {
  defaultMessage: "timeframe",
});
const timeframeDescp = i18n.translate("components.addModule.guide.timeframeDescp", {
  defaultMessage:
    "Time interval in which the number of alerts generated by a file accumulates.",
});
const timeframePlace = i18n.translate("components.addModule.guide.timeframePlace", {
  defaultMessage: "Time in seconds",
});
const timeframeError = i18n.translate("components.addModule.guide.timeframeError", {
  defaultMessage:
    "Any number between 1 and 43200.",
});
const alert_new_filesName = i18n.translate("components.addModule.guide.alert_new_filesName", {
  defaultMessage: "alert_new_files",
});
const alert_new_filesDescp = i18n.translate("components.addModule.guide.alert_new_filesDescp", {
  defaultMessage:
    "Specifies if syscheck should alert when new files are created.",
});
const alert_new_filesInfo = i18n.translate("components.addModule.guide.alert_new_filesInfo", {
  defaultMessage: "It is valid on: server and local.",
});
const scan_on_startName = i18n.translate("components.addModule.guide.scan_on_startName", {
  defaultMessage: "scan_on_start",
});
const scan_on_startDescp = i18n.translate("components.addModule.guide.scan_on_startDescp", {
  defaultMessage:
    "Specifies if syscheck scans immediately when started",
});
const allow_remote_prefilter_cmdName = i18n.translate("components.addModule.guide.allow_remote_prefilter_cmdName", {
  defaultMessage: "allow_remote_prefilter_cmd",
});
const allow_remote_prefilter_cmdDescp = i18n.translate("components.addModule.guide.allow_remote_prefilter_cmdDescp", {
  defaultMessage:
    "Allows prefilter_cmd option apply in remote configuration (agent.conf).",
});
const allow_remote_prefilter_cmdInfo = i18n.translate("components.addModule.guide.allow_remote_prefilter_cmdInfo", {
  defaultMessage: "This option only can be activate from the agent side, in its own ossec.conf.",
});
const prefilter_cmdName = i18n.translate("components.addModule.guide.prefilter_cmdName", {
  defaultMessage: "prefilter_cmd",
});
const prefilter_cmdDescp = i18n.translate("components.addModule.guide.prefilter_cmdDescp", {
  defaultMessage:
    "Run to prevent prelinking from creating false positives.",
});
const prefilter_cmdInfo = i18n.translate("components.addModule.guide.prefilter_cmdInfo", {
...
const skip_nfsName = i18n.translate("components.addModule.guide.skip_nfsName", {
  defaultMessage: "skip_nfs",
});
const skip_nfsDescp = i18n.translate("components.addModule.guide.skip_nfsDescp", {
  defaultMessage:
...
const skip_devName = i18n.translate("components.addModule.guide.skip_devName", {
  defaultMessage: "skip_dev",
});
const skip_devDescp = i18n.translate("components.addModule.guide.skip_devDescp", {
  defaultMessage:
    "Specifies if syscheck should scan the /dev directory. (Works on Linux and FreeBSD).",
});
const skip_sysName = i18n.translate("components.addModule.guide.skip_sysName", {
  defaultMessage: "skip_sys",
});
const skip_sysDescp = i18n.translate("components.addModule.guide.skip_sysDescp", {
  defaultMessage:
    "Specifies if syscheck should scan the /sys directory. (Works on Linux).",
});
const skip_procName = i18n.translate("components.addModule.guide.skip_procName", {
  defaultMessage: "skip_proc",
});
const skip_procDescp = i18n.translate("components.addModule.guide.skip_procDescp", {
  defaultMessage:
    "Specifies if syscheck should scan the /proc directory. (Works on Linux and FreeBSD).",
});
const windows_audit_intervalName = i18n.translate("components.addModule.guide.windows_audit_intervalName", {
  defaultMessage: "windows_audit_interval",
});
const windows_audit_intervalDescp = i18n.translate("components.addModule.guide.windows_audit_intervalDescp", {
  defaultMessage:
...
const windows_audit_intervalPlace = i18n.translate("components.addModule.guide.windows_audit_intervalPlace", {
  defaultMessage: "Time in seconds",
});
const windows_audit_intervalError = i18n.translate("components.addModule.guide.windows_audit_intervalError", {
  defaultMessage:
    "Any number from 1 to 9999.",
});
const process_priorityName = i18n.translate("components.addModule.guide.process_priorityName", {
  defaultMessage: "process_priority",
});
const process_priorityDescp = i18n.translate("components.addModule.guide.process_priorityDescp", {
  defaultMessage:
    "Set the nice value for Syscheck process.",
});
const process_priorityInfo = i18n.translate("components.addModule.guide.process_priorityInfo", {
...
const process_priorityPlace = i18n.translate("components.addModule.guide.process_priorityPlace", {
  defaultMessage: "Time in seconds",
});
const process_priorityError = i18n.translate("components.addModule.guide.process_priorityError", {
  defaultMessage:
    "Integer number between -20 and 19.",
});
const max_epsName = i18n.translate("components.addModule.guide.max_epsName", {
  defaultMessage: "max_eps",
});
const max_epsDescp = i18n.translate("components.addModule.guide.max_epsDescp", {
  defaultMessage:
    "Set the maximum event reporting throughput. Events are messages that will produce an alert.",
});
const max_epsInfo = i18n.translate("components.addModule.guide.max_epsInfo", {
  defaultMessage: "0 means disabled.",
});
const max_epsPlace = i18n.translate("components.addModule.guide.max_epsPlace", {
  defaultMessage: "Process priority",
});
const max_epsError = i18n.translate("components.addModule.guide.max_epsError", {
  defaultMessage:
    "Integer number between 0 and 1000000.",
});
const databaseName = i18n.translate("components.addModule.guide.databaseName", {
  defaultMessage: "database",
});
const databaseDescp = i18n.translate("components.addModule.guide.databaseDescp", {
  defaultMessage:
...
const synchronizationName = i18n.translate("components.addModule.guide.synchronizationName", {
  defaultMessage: "synchronization",
});
const synchronizationDescp = i18n.translate("components.addModule.guide.synchronizationDescp", {
  defaultMessage:
    "The database synchronization settings will be configured inside this tag.",
});
const SpecifiesName = i18n.translate("components.addModule.guide.SpecifiesName", {
  defaultMessage: "enabled",
});
const SpecifiesDescp = i18n.translate("components.addModule.guide.SpecifiesDescp", {
  defaultMessage:
...
const max_intervalName = i18n.translate("components.addModule.guide.max_intervalName", {
  defaultMessage: "max_interval",
});
const max_intervalDescp = i18n.translate(
  "components.addModule.guide.max_intervalDescp",
  {
...
const max_intervalDefault = i18n.translate(
  "components.addModule.guide.max_intervalDefault",
  {
    defaultMessage: "1h",
  }
);
const max_intervalError = i18n.translate(
  "components.addModule.guide.max_intervalError",
  {
    defaultMessage:
      "Any number greater than or equal to 0. Allowed sufixes (s, m, h, d).",
  }
);
const response_timeoutName = i18n.translate("components.addModule.guide.response_timeoutName", {
  defaultMessage: "response_timeout",
});
const response_timeoutDescp = i18n.translate(
  "components.addModule.guide.response_timeoutDescp",
  {
...
const whodataDescp = i18n.translate(
  "components.addModule.guide.whodataDescp",
  {
    defaultMessage: "The Whodata options will be configured inside this tag.",
  }
);
const restart_auditName = i18n.translate("components.addModule.guide.restart_auditName", {
  defaultMessage: "restart_audit",
});
const restart_auditDescp = i18n.translate(
  "components.addModule.guide.restart_auditDescp",
  {
...
const audit_keyName = i18n.translate("components.addModule.guide.audit_keyName", {
  defaultMessage: "audit_key",
});
const audit_keyDescp = i18n.translate(
  "components.addModule.guide.audit_keyDescp",
  {
...
const audit_keyInfo = i18n.translate(
  "components.addModule.guide.audit_keyInfo",
  {
...
const audit_keyPlace = i18n.translate(
  "components.addModule.guide.audit_keyPlace",
  {
    defaultMessage: "Any string separated by commas",
  }
);
const audit_keyError = i18n.translate(
  "components.addModule.guide.audit_keyError",
  {
    defaultMessage:
      "Any string separated by commas",
  }
);
const startup_healthcheckName = i18n.translate("components.addModule.guide.startup_healthcheckName", {
  defaultMessage: "startup_healthcheck",
});
const startup_healthcheckDescp = i18n.translate(
  "components.addModule.guide.startup_healthcheckDescp",
  {
...
const startup_healthcheckWar = i18n.translate(
  "components.addModule.guide.startup_healthcheckWar",
  {
...
const check_sha1sumName = i18n.translate("components.addModule.guide.check_sha1sumName", {
  defaultMessage: "check_sha1sum",
});
const check_sha1sumDescp = i18n.translate("components.addModule.guide.check_sha1sumDescp", {
