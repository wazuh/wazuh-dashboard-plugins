...
const sysCheckName = i18n.translate(
  'wazuh.components.addModule.guide.sysCheckName',
  {
...
const sysCheckCate = i18n.translate(
  'wazuh.components.addModule.guide.sysCheckCate',
  {
...
const title = i18n.translate(
  'wazuh.components.addModule.guide.titleMonitoring',
  {
    defaultMessage: 'Directories/files to monitoring',
  },
);
const titleDescp = i18n.translate(
  'wazuh.components.addModule.guide.titleDescp',
  {
    defaultMessage:
      'Add or remove directories to be monitored. You can add multiple directories with different monitoring configurations.',
  },
);
const directoriesName = i18n.translate(
  'wazuh.components.addModule.guide.directoriesName',
  {
    defaultMessage: 'directories',
  },
);
const directoriesDescp = i18n.translate(
  'wazuh.components.addModule.guide.directoriesDescp',
  {
    defaultMessage:
      'Use this option to add or remove directories to be monitored. The directories must be comma separated.All files and subdirectories within the noted directories will also be monitored.Drive letters without directories are not valid. At a minimum the ‘.’ should be included (D:\\.).This is to be set on the system to be monitored (or in the agent.conf, if appropriate).',
  },
);
...
const realtimeName = i18n.translate(
  'wazuh.components.addModule.guide.realtimeName',
  {
    defaultMessage: 'realtime',
  },
);
const realtimeDescp = i18n.translate(
  'wazuh.components.addModule.guide.realtimeDescp',
  {
    defaultMessage:
...
const whoDataName = i18n.translate(
  'wazuh.components.addModule.guide.whoDataName',
  {
...
const reportName = i18n.translate(
  'wazuh.components.addModule.guide.reportName',
  {
    defaultMessage: 'report_changes',
  },
);
const reportDescp = i18n.translate(
  'wazuh.components.addModule.guide.reportDescp',
  {
    defaultMessage:
...
const checkAllName = i18n.translate(
  'wazuh.components.addModule.guide.checkAllName',
  {
...
const checkSumName = i18n.translate(
  'wazuh.components.addModule.guide.checkSumName',
  {
    defaultMessage: 'check_sum',
  },
);
const checkSumDescp = i18n.translate(
  'wazuh.components.addModule.guide.checkSumDescp',
  {
    defaultMessage:
      'Check the MD5, SHA-1 and SHA-256 hashes of the files.Same as using check_md5sum="yes", check_sha1sum="yes" and check_sha256sum="yes" at the same time.',
  },
);

const checkMd5Name = i18n.translate(
  'wazuh.components.addModule.guide.checkMd5Name',
  {
    defaultMessage: 'check_md5sum',
  },
);
const checkMd5Descp = i18n.translate(
  'wazuh.components.addModule.guide.checkMd5Descp',
  {
    defaultMessage: 'Check only the MD5 hash of the files.',
  },
);

const check_sha256sumName = i18n.translate(
  'wazuh.components.addModule.guide.check_sha256sumName',
  {
    defaultMessage: 'check_sha256sum',
  },
);
const check_sha256sumDescp = i18n.translate(
  'wazuh.components.addModule.guide.check_sha256sumDescp',
  {
    defaultMessage: 'Check only the SHA-256 hash of the files.',
  },
);

const check_sizeName = i18n.translate(
  'wazuh.components.addModule.guide.check_sizeName',
  {
    defaultMessage: 'check_size',
  },
);
const check_sizeDescp = i18n.translate(
  'wazuh.components.addModule.guide.check_sizeDescp',
  {
    defaultMessage: 'Check the size of the files.',
  },
);

const check_ownerName = i18n.translate(
  'wazuh.components.addModule.guide.check_ownerName',
  {
    defaultMessage: 'check_owner',
  },
);
const check_ownerDescp = i18n.translate(
  'wazuh.components.addModule.guide.check_ownerDescp',
  {
    defaultMessage:
...
const check_groupName = i18n.translate(
  'wazuh.components.addModule.guide.check_groupName',
  {
    defaultMessage: 'check_group',
  },
);
const check_groupDescp = i18n.translate(
  'wazuh.components.addModule.guide.check_groupDescp',
  {
    defaultMessage:
...
const check_permName = i18n.translate(
  'wazuh.components.addModule.guide.check_permName',
  {
    defaultMessage: 'check_perm',
  },
);
const check_permDescp = i18n.translate(
  'wazuh.components.addModule.guide.check_permDescp',
  {
    defaultMessage:
...
const check_attrsName = i18n.translate(
  'wazuh.components.addModule.guide.check_attrsName',
  {
    defaultMessage: 'check_attrs',
  },
);
const check_attrsDescp = i18n.translate(
  'wazuh.components.addModule.guide.check_attrsDescp',
  {
    defaultMessage: 'Check the attributes of the files.Available for Windows',
  },
);

const check_mtimeName = i18n.translate(
  'wazuh.components.addModule.guide.check_mtimeName',
  {
    defaultMessage: 'check_mtime',
  },
);
const check_mtimeDescp = i18n.translate(
  'wazuh.components.addModule.guide.check_mtimeDescp',
  {
    defaultMessage: 'Check the modification time of a file.',
  },
);

const check_inodeName = i18n.translate(
  'wazuh.components.addModule.guide.check_inodeName',
  {
    defaultMessage: 'check_inode',
  },
);
const check_inodeDescp = i18n.translate(
  'wazuh.components.addModule.guide.check_inodeDescp',
  {
    defaultMessage:
...
const restrictName = i18n.translate(
  'wazuh.components.addModule.guide.restrictName',
  {
    defaultMessage: 'restrict',
  },
);
const restrictDescp = i18n.translate(
  'wazuh.components.addModule.guide.restrictDescp',
  {
    defaultMessage:
...
const restrictError = i18n.translate(
  ...
  {
    defaultMessage: 'Any directory or file name (but not a path) is allowed',
  },
);

const tagsMonitor = i18n.translate(
  'wazuh.components.addModule.guide.tagsDescp',
  {
    defaultMessage: 'Add tags to alerts for monitored directories.',
  },
);
const tagsMonitorPlace = i18n.translate(
  'wazuh.components.addModule.guide.tagsplace',
  {
    defaultMessage: 'Tags list separated by commas',
  },
);

const recursion_levelName = i18n.translate(
  'wazuh.components.addModule.guide.recursion_levelName',
  {
    defaultMessage: 'recursion_level',
  },
);
const recursion_levelDescp = i18n.translate(
  'wazuh.components.addModule.guide.recursion_levelDescp',
  {
...
const follow_symbolic_linkName = i18n.translate(
  'wazuh.components.addModule.guide.follow_symbolic_linkName',
  {
    defaultMessage: 'follow_symbolic_link',
  },
);
const follow_symbolic_linkDescp = i18n.translate(
  'wazuh.components.addModule.guide.follow_symbolic_linkDescp',
  {
    defaultMessage:
      'Follow symbolic links (directories or files). The default value is “no”. The setting is available for UNIX systems.If set, realtime works as usual (with symbolic links to directories, not files).',
  },
);
const title1 = i18n.translate(
  'wazuh.components.addModule.guide.ignoreDirectories',
  {
    defaultMessage: 'Ignore directories and/or files',
  },
);
const title1Descp = i18n.translate(
  'wazuh.components.addModule.guide.listOfFiles',
  {
    defaultMessage:
      'List of files or directories to be ignored. You can add multiple times this option. These files and directories are still checked, but the results are ignored.',
  },
);
const ignoreName = i18n.translate(
  'wazuh.components.addModule.guide.ignoreName',
  {
...
const sregexName = i18n.translate(
  'wazuh.components.addModule.guide.sregexName',
  {
    defaultMessage: 'type',
  },
);
...
const title2 = i18n.translate(
  'wazuh.components.addModule.guides.fim.notCompute',
  {
    defaultMessage: 'Not compute',
  },
);
const title2Descp = i18n.translate(
  'wazuh.components.addModule.guide.title2Descp',
  {
    defaultMessage:
      'List of files to not compute the diff. You can add multiple times this option. It could be used for sensitive files like a private key, credentials stored in a file or database configuration, avoiding data leaking by sending the file content changes through alerts..',
  },
);
const nodiffName = i18n.translate(
  'wazuh.components.addModule.guide.nodiffName',
  {
...
const nodiffError = i18n.translate(
  ...
  {
    defaultMessage: 'Any file name. e.g. /etc/ssl/private.key',
  },
);
const title3 = i18n.translate('wazuh.components.addModule.guide.fim.scan', {
  defaultMessage: 'Scan day',
});
const title3Descp = i18n.translate(
  'wazuh.components.addModule.guide.title3Descp',
  {
    defaultMessage:
      'Day of the week to run the scans. You can add multiple times this option.',
  },
);
const scan_dayName = i18n.translate(
  'wazuh.components.addModule.guide.scan_dayName',
  {
...
const weakDaysName = i18n.translate(
  'wazuh.components.addModule.guide.weakDaysName',
  {
...
const weakDaysDefault = i18n.translate(
  'wazuh.components.addModule.guide.weakDaysDefault',
  {
    defaultMessage: 'sunday',
  },
);
const weakDaysError = i18n.translate(
  'wazuh.components.addModule.guide.weakDaysError',
  {
    defaultMessage: 'Day of the week.',
  },
);
const title4 = i18n.translate(
  'wazuh.components.addModule.guide.windowRegistry',
  {
    defaultMessage: 'Windows registry',
  },
);
const title4Descp = i18n.translate(
  'wazuh.components.addModule.guide.windowOption',
  {
    defaultMessage:
      'Use this option to monitor specified Windows registry entries. You can add multiple times this option.',
  },
);
const winName = i18n.translate('wazuh.components.addModule.guide.winName', {
  defaultMessage: 'windows_registry',
});
const winDescp = i18n.translate('wazuh.components.addModule.guide.winDescp', {
  defaultMessage:
    "Use this option to monitor specified Windows registry entries',info: 'New entries will not trigger alerts, only changes to existing entries.",
});
...
const archDescp = i18n.translate('wazuh.components.addModule.guide.archDescp', {
  defaultMessage: 'Select the Registry view depending on the architecture.',
});
const text1 = i18n.translate('wazuh.components.addModule.guide.bitText', {
  defaultMessage: '32bit',
});
const text2 = i18n.translate('wazuh.components.addModule.guide.fim.bit', {
  defaultMessage: '64bit',
});
const text3 = i18n.translate('wazuh.components.addModule.guide.text3', {
  defaultMessage: 'both',
});
const tagsName = i18n.translate('wazuh.components.addModule.guide.tagsName', {
  defaultMessage: 'tags',
});
const tagsDescp = i18n.translate(
  'wazuh.components.addModule.guide.monitorEntries',
  {
...
const title5Descp = i18n.translate(
  'wazuh.components.addModule.guide.title5Descp',
  {
    defaultMessage: 'List of registry entries to be ignored.',
  },
);
const registry_ignoreName = i18n.translate(
  'wazuh.components.addModule.guide.registry_ignoreName',
  {
    defaultMessage: 'registry_ignore',
  },
);
const registry_ignoreDescp = i18n.translate(
  'wazuh.components.addModule.guide.registry_ignoreDescp',
  {
    defaultMessage:
...
const registry_ignorePlace = i18n.translate(
  'wazuh.components.addModule.guide.registry_ignorePlace',
  {
    defaultMessage: 'Any registry entry.',
  },
);
const registry_ignoreError = i18n.translate(
  'wazuh.components.addModule.guide.registry_ignoreError',
  {
    defaultMessage: 'Any registry entry.',
  },
);
...
const frequencyName = i18n.translate(
  'wazuh.components.addModule.guide.frequencyName',
  {
    defaultMessage: 'frequency',
  },
);
const frequencyDescp = i18n.translate(
  'wazuh.components.addModule.guide.frequencyDescp',
  {
    defaultMessage: 'Frequency that the syscheck will be run (in seconds).',
  },
);
const frequencyPlace = i18n.translate(
  'wazuh.components.addModule.guide.frequencyPlace',
  {
    defaultMessage: 'Time in seconds.',
  },
);
const frequencyError = i18n.translate(
  'wazuh.components.addModule.guide.frequencyError',
  {
    defaultMessage: 'A positive number, time in seconds.',
  },
);
const scan_timeName = i18n.translate(
  'wazuh.components.addModule.guide.scan_timeName',
  {
    defaultMessage: 'scan_time',
  },
);
const scan_timeDescp = i18n.translate(
  'wazuh.components.addModule.guide.scan_timeDescp',
  {
    defaultMessage:
      'Time to run the scans. Times may be represented as 9pm or 8:30.',
  },
);
const scan_timePlace = i18n.translate(
  'wazuh.components.addModule.guide.scan_timePlace',
  {
    defaultMessage: 'Time of day',
  },
);
const scan_timeInfo = i18n.translate(
  'wazuh.components.addModule.guide.scan_timeInfo',
  {
    defaultMessage: 'This may delay the initialization of real-time scans.',
  },
);
const scan_timeError = i18n.translate(
  'wazuh.components.addModule.guide.scan_timeError',
  {
    defaultMessage: 'Time of day represented as 9pm or 8:30',
  },
);
const scan_timeWar = i18n.translate(
  'wazuh.components.addModule.guide.scan_timeWar',
  {
    defaultMessage: 'This may delay the initialization of real-time scans.',
  },
);
const auto_ignoreName = i18n.translate(
  'wazuh.components.addModule.guide.auto_ignoreName',
  {
    defaultMessage: 'auto_ignore',
  },
);
const auto_ignoreDescp = i18n.translate(
  'wazuh.components.addModule.guide.auto_ignoreDescp',
  {
    defaultMessage:
      'Specifies whether or not syscheck will ignore files that change too many times (manager only).',
  },
);
const auto_ignoreInfo = i18n.translate(
  'wazuh.components.addModule.guide.auto_ignoreInfo',
  {
    defaultMessage: 'It is valid on: server and local.',
  },
);
const frequency1Name = i18n.translate(
  'wazuh.components.addModule.guide.frequency1Name',
  {
    defaultMessage: 'frequency',
  },
);
const frequency1Descp = i18n.translate(
  'wazuh.components.addModule.guide.frequency1Descp',
  {
    defaultMessage:
      "Number of times the alert can be repeated in the 'timeframe' time interval..",
  },
);
const frequency1Error = i18n.translate(
  'wazuh.components.addModule.guide.frequency1Error',
  {
    defaultMessage: 'Any number between 1 and 99.',
  },
);
const timeframeName = i18n.translate(
  'wazuh.components.addModule.guide.timeframeName',
  {
    defaultMessage: 'timeframe',
  },
);
const timeframeDescp = i18n.translate(
  'wazuh.components.addModule.guide.timeframeDescp',
  {
    defaultMessage:
      'Time interval in which the number of alerts generated by a file accumulates.',
  },
);
const timeframePlace = i18n.translate(
  'wazuh.components.addModule.guide.timeframePlace',
  {
    defaultMessage: 'Time in seconds',
  },
);
const timeframeError = i18n.translate(
  'wazuh.components.addModule.guide.timeframeError',
  {
    defaultMessage: 'Any number between 1 and 43200.',
  },
);
const alert_new_filesName = i18n.translate(
  'wazuh.components.addModule.guide.alert_new_filesName',
  {
    defaultMessage: 'alert_new_files',
  },
);
const alert_new_filesDescp = i18n.translate(
  'wazuh.components.addModule.guide.alert_new_filesDescp',
  {
    defaultMessage:
      'Specifies if syscheck should alert when new files are created.',
  },
);
const alert_new_filesInfo = i18n.translate(
  'wazuh.components.addModule.guide.alert_new_filesInfo',
  {
    defaultMessage: 'It is valid on: server and local.',
  },
);
const scan_on_startName = i18n.translate(
  'wazuh.components.addModule.guide.scan_on_startName',
  {
    defaultMessage: 'scan_on_start',
  },
);
const scan_on_startDescp = i18n.translate(
  'wazuh.components.addModule.guide.scan_on_startDescp',
  {
    defaultMessage: 'Specifies if syscheck scans immediately when started',
  },
);
const allow_remote_prefilter_cmdName = i18n.translate(
  'wazuh.components.addModule.guide.allow_remote_prefilter_cmdName',
  {
    defaultMessage: 'allow_remote_prefilter_cmd',
  },
);
const allow_remote_prefilter_cmdDescp = i18n.translate(
  'wazuh.components.addModule.guide.allow_remote_prefilter_cmdDescp',
  {
    defaultMessage:
      'Allows prefilter_cmd option apply in remote configuration (agent.conf).',
  },
);
const allow_remote_prefilter_cmdInfo = i18n.translate(
  'wazuh.components.addModule.guide.allow_remote_prefilter_cmdInfo',
  {
    defaultMessage:
      'This option only can be activate from the agent side, in its own ossec.conf.',
  },
);
const prefilter_cmdName = i18n.translate(
  'wazuh.components.addModule.guide.prefilter_cmdName',
  {
    defaultMessage: 'prefilter_cmd',
  },
);
const prefilter_cmdPlace = i18n.translate(
  'wazuh.components.addModule.guide.prefilter_cmdPlace',
  {
    defaultMessage: 'Command to prevent prelinking.',
  },
);
const prefilter_cmdDescp = i18n.translate(
  'wazuh.components.addModule.guide.prefilter_cmdDescp',
  {
    defaultMessage: 'Run to prevent prelinking from creating false positives.',
  },
);
const prefilter_cmdInfo = i18n.translate(
  'wazuh.components.addModule.guide.prefilter_cmdInfo',
  {
    defaultMessage:
      'This option may negatively impact performance as the configured command will be run for each file checked.This option is ignored when defined at agent.conf if allow_remote_prefilter_cmd is set to no at ossec.conf.',
  },
);
const skip_nfsName = i18n.translate(
  'wazuh.components.addModule.guide.skip_nfsName',
  {
    defaultMessage: 'skip_nfs',
  },
);
const skip_nfsDescp = i18n.translate(
  'wazuh.components.addModule.guide.skip_nfsDescp',
  {
    defaultMessage:
...
const skip_devName = i18n.translate(
  'wazuh.components.addModule.guide.skip_devName',
  {
    defaultMessage: 'skip_dev',
  },
);
const skip_devDescp = i18n.translate(
  'wazuh.components.addModule.guide.skip_devDescp',
  {
    defaultMessage:
      'Specifies if syscheck should scan the /dev directory. (Works on Linux and FreeBSD).',
  },
);
const skip_sysName = i18n.translate(
  'wazuh.components.addModule.guide.skip_sysName',
  {
    defaultMessage: 'skip_sys',
  },
);
const skip_sysDescp = i18n.translate(
  'wazuh.components.addModule.guide.skip_sysDescp',
  {
    defaultMessage:
      'Specifies if syscheck should scan the /sys directory. (Works on Linux).',
  },
);
const skip_procName = i18n.translate(
  'wazuh.components.addModule.guide.skip_procName',
  {
    defaultMessage: 'skip_proc',
  },
);
const skip_procDescp = i18n.translate(
  'wazuh.components.addModule.guide.skip_procDescp',
  {
    defaultMessage:
      'Specifies if syscheck should scan the /proc directory. (Works on Linux and FreeBSD).',
  },
);
const windows_audit_intervalName = i18n.translate(
  'wazuh.components.addModule.guide.windows_audit_intervalName',
  {
    defaultMessage: 'windows_audit_interval',
  },
);
const windows_audit_intervalDescp = i18n.translate(
  'wazuh.components.addModule.guide.windows_audit_intervalDescp',
  {
    defaultMessage:
...
const windows_audit_intervalPlace = i18n.translate(
  'wazuh.components.addModule.guide.windows_audit_intervalPlace',
  {
    defaultMessage: 'Time in seconds',
  },
);
const windows_audit_intervalError = i18n.translate(
  'wazuh.components.addModule.guide.windows_audit_intervalError',
  {
    defaultMessage: 'Any number from 1 to 9999.',
  },
);
const process_priorityName = i18n.translate(
  'wazuh.components.addModule.guide.process_priorityName',
  {
    defaultMessage: 'process_priority',
  },
);
const process_priorityDescp = i18n.translate(
  'wazuh.components.addModule.guide.process_priorityDescp',
  {
    defaultMessage: 'Set the nice value for Syscheck process.',
  },
);
const process_priorityInfo = i18n.translate(
  'wazuh.components.addModule.guide.process_priorityInfo',
  {
    defaultMessage:
      'The "niceness" scale in Linux goes from -20 to 19, whereas -20 is the highest priority and 19 the lowest priority.',
  },
);
const process_priorityPlace = i18n.translate(
  'wazuh.components.addModule.guide.process_priorityPlace',
  {
    defaultMessage: 'Time in seconds',
  },
);
const process_priorityError = i18n.translate(
  'wazuh.components.addModule.guide.process_priorityError',
  {
    defaultMessage: 'Integer number between -20 and 19.',
  },
);
const max_epsName = i18n.translate(
  'wazuh.components.addModule.guide.max_epsName',
  {
    defaultMessage: 'max_eps',
  },
);
const max_epsDescp = i18n.translate(
  'wazuh.components.addModule.guide.max_epsDescp',
  {
    defaultMessage:
      'Set the maximum event reporting throughput. Events are messages that will produce an alert.',
  },
);
const max_epsInfo = i18n.translate(
  'wazuh.components.addModule.guide.max_epsInfo',
  {
    defaultMessage: '0 means disabled.',
  },
);
const max_epsPlace = i18n.translate(
  'wazuh.components.addModule.guide.max_epsPlace',
  {
    defaultMessage: 'Process priority',
  },
);
const max_epsError = i18n.translate(
  'wazuh.components.addModule.guide.max_epsError',
  {
    defaultMessage: 'Integer number between 0 and 1000000.',
  },
);
const databaseName = i18n.translate(
  'wazuh.components.addModule.guide.databaseName',
  {
    defaultMessage: 'database',
  },
);
const databaseDescp = i18n.translate(
  'wazuh.components.addModule.guide.databaseDescp',
  {
    defaultMessage: 'Specify where is the database going to be stored.',
  },
);
...
const synchronizationName = i18n.translate(
  'wazuh.components.addModule.guide.synchronizationName',
  {
    defaultMessage: 'synchronization',
  },
);
const synchronizationDescp = i18n.translate(
  'wazuh.components.addModule.guide.synchronizationDescp',
  {
    defaultMessage:
      'The database synchronization settings will be configured inside this tag.',
  },
);
const SpecifiesName = i18n.translate(
  'wazuh.components.addModule.guide.SpecifiesName',
  {
    defaultMessage: 'enabled',
  },
);
const SpecifiesDescp = i18n.translate(
  'wazuh.components.addModule.guide.SpecifiesDescp',
  {
    defaultMessage:
      'Specifies whether there will be periodic inventory synchronizations or not.',
  },
);
const intervalName = i18n.translate(
  'wazuh.components.addModule.guide.intervalName',
  {
...
const max_intervalName = i18n.translate(
  'wazuh.components.addModule.guide.max_intervalName',
  {
...
const response_timeoutName = i18n.translate(
  'wazuh.components.addModule.guide.response_timeoutName',
  {
...
const response_timeoutError = i18n.translate(
  ...
  {
    defaultMessage: 'Any number greater than or equal to 0.',
  },
);
const queue_sizeName = i18n.translate(
  'wazuh.components.addModule.guide.queue_sizeName',
  {
...
const queue_sizeError = i18n.translate(
  ...
  {
    defaultMessage: 'Integer number between 2 and 1000000.',
  },
);
...
const max_epsErrorDescription = i18n.translate(
  ...
  {
    defaultMessage: 'Integer number between 0 and 1000000. 0 means disabled.',
  },
);
const whodataName = i18n.translate(
  'wazuh.components.addModule.guide.whodataName',
...
const restart_auditName = i18n.translate(
  'wazuh.components.addModule.guide.restart_auditName',
  {
...
const audit_keyName = i18n.translate(
  'wazuh.components.addModule.guide.audit_keyName',
  {
...
const startup_healthcheckName = i18n.translate(
  'wazuh.components.addModule.guide.startup_healthcheckName',
  {
...
const check_sha1sumName = i18n.translate(
  'wazuh.components.addModule.guide.check_sha1sumName',
  {
    defaultMessage: 'check_sha1sum',
  },
);
const check_sha1sumDescp = i18n.translate(
  'wazuh.components.addModule.guide.check_sha1sumDescp',
  {
    ...
    },
    {
      ...
      elements: [
        ...
        },
        {
          ...
          description: prefilter_cmdDescp,
          info: prefilter_cmdInfo,
          type: 'input',
          placeholder: prefilter_cmdPlace,
        },
        {
          name: skip_nfsName,
          description: skip_nfsDescp,
          type: 'switch',
          default_value: true,
        },
        {
          name: skip_devName,
          description: skip_devDescp,
          type: 'switch',
          default_value: true,
        },
        {
          name: skip_sysName,
          description: skip_sysDescp,
          type: 'switch',
          default_value: true,
        },
        {
          name: skip_procName,
          description: skip_procDescp,
          type: 'switch',
          default_value: true,
        },
        {
          name: windows_audit_intervalName,
          description: windows_audit_intervalDescp,
          type: 'input-number',
        ...
        },
        {
          ...
          description: synchronizationDescp,
          show_options: true,
          options: [
            {
              name: SpecifiesName,
              description: SpecifiesDescp,
              type: 'switch',
              default_value: true,
              required: true,
            },
            ...
            },
            {
              ...
              description: max_intervalDescp,
              type: 'input',
              default_value: max_intervalDefault,
              required: true,
              validate_error_message: max_intervalError,
              validate_regex: /^[1-9]\d*[s|m|h|d]$/,
            },
            {
              name: response_timeoutName,
              description: response_timeoutDescp,
              type: 'input-number',
              default_value: 30,
              required: true,
              values: { min: 0 },
          ...
          options: [
            {
              ...
              description: restart_auditDescp,
              type: 'switch',
              default_value: true,
            },
            {
              name: audit_keyName,
              description: audit_keyDescp,
              info: audit_keyInfo,
              type: 'input',
            ...
            },
            {
              ...
              description: startup_healthcheckDescp,
              warning: startup_healthcheckWar,
              type: 'switch',
              default_value: true,
              agent_os: 'linux',
            },
