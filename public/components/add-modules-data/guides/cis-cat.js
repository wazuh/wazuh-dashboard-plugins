...
const cisName = i18n.translate('components.addModule.guide.cisName', {
  defaultMessage: 'CIS-CAT',
});
const cisWodleName = i18n.translate('components.addModule.guide.cisWodleName', {
  defaultMessage: 'cis-cat',
});
const cisDescp = i18n.translate('components.addModule.guide.cisDescp', {
  defaultMessage: 'Configuration options of the CIS-CAT wodle.',
});
const cisCate = i18n.translate('components.addModule.guide.cisCate', {
...
const javaName = i18n.translate('components.addModule.guide.javaName', {
  defaultMessage: 'java_path',
});
const javaDescp = i18n.translate('components.addModule.guide.javaDescp', {
  defaultMessage:
...
const javaPlace = i18n.translate('components.addModule.guide.timePlace', {
  defaultMessage: 'Java location',
});
const javaWar = i18n.translate('components.addModule.guide.jawaWar', {
  defaultMessage:
...
const cisPathName = i18n.translate('components.addModule.guide.cisPathName', {
  defaultMessage: 'ciscat_path',
});
const cisPathDescp = i18n.translate('components.addModule.guide.cisPathDescp', {
  defaultMessage: 'Define where CIS-CAT is located.',
});
const cisPathPlace = i18n.translate('components.addModule.guide.cisPathPlace', {
  defaultMessage: 'CIS-CAT location',
});
const cisPathError = i18n.translate('components.addModule.guide.cisPathError', {
...
const dayName = i18n.translate('components.addModule.guide.dayName', {
  defaultMessage: 'day',
});
const dayDescp = i18n.translate('components.addModule.guide.dayDescp', {
  defaultMessage: 'Day of the month to run the CIS-CAT scan.',
});
const dayInfo = i18n.translate('components.addModule.guide.dayInfo', {
  defaultMessage:
    'When the day option is set, the interval value must be a multiple of months. By default, the interval is set to a month.',
});
const wDayName = i18n.translate('components.addModule.guide.wDayName', {
  defaultMessage: 'wday',
});
const wDayDescp = i18n.translate('components.addModule.guide.wDayDescp', {
  defaultMessage:
    'Day of the week to run the CIS-CAT scan. This option is not compatible with the day option.',
});
const wDayInfo = i18n.translate('components.addModule.guide.wDayInfo', {
  defaultMessage:
...
const wDayPlace = i18n.translate('components.addModule.guide.wDayPlace', {
  defaultMessage: 'Day of the month [1..31]',
});
const wDayError = i18n.translate('components.addModule.guide.wDayError', {
  defaultMessage: 'sunday',
});
const wDayDefault = i18n.translate('components.addModule.guide.wDayDefault', {
  defaultMessage: 'Day of the month [1..31]',
});
const timeDayName = i18n.translate('components.addModule.guide.timeDayName', {
  defaultMessage: 'time',
});
const timeDayDescp = i18n.translate('components.addModule.guide.timeDayDescp', {
  defaultMessage:
    'Time of the day to run the scan. It has to be represented in the format hh:mm.',
});
const timeDayPlace = i18n.translate('components.addModule.guide.timeDayPlace', {
  defaultMessage: 'Time of day',
});
const timeDayError = i18n.translate('components.addModule.guide.timeDayError', {
...
const selContentName = i18n.translate(
  'components.addModule.guide.selContentName',
  {
    defaultMessage: 'type',
  },
);
const selContentDescp = i18n.translate(
  'components.addModule.guide.selContentDescp',
  {
    defaultMessage: 'Select content type.',
  },
);
const selContentDefault = i18n.translate(
  'components.addModule.guide.selContentDefault',
  {
    defaultMessage: 'xccdf',
  },
);
const policyName = i18n.translate('components.addModule.guide.policyName', {
  defaultMessage: 'path',
});
const policyDescp = i18n.translate('components.addModule.guide.policyDescp', {
  defaultMessage: 'Use the specified policy file.',
});
const policyInfo = i18n.translate('components.addModule.guide.policyInfo', {
  defaultMessage:
...
const policyPlace = i18n.translate('components.addModule.guide.policyPlace', {
  defaultMessage: 'Path where the benchmark files are located',
});
const policyError = i18n.translate('components.addModule.guide.policyError', {
  defaultMessage: 'Path where the benchmark files are located',
});
