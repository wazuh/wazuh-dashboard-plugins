...
const auditTag = i18n.translate('components.addModule.guide.auditTag', {
  defaultMessage: 'localfile',
});
const auditDescp = i18n.translate('components.addModule.guide.auditDescp', {
  defaultMessage: 'Configuration options of the System auditing extension.',
});
const auditCate = i18n.translate('components.addModule.guide.auditCate', {
  defaultMessage: 'Auditing and policy monitoring',
});
const auditIcon = i18n.translate('components.addModule.guide.auditIcon', {
  defaultMessage: 'securityApp',
});
const titleSet = i18n.translate('components.addModule.guide.titleSet', {
  defaultMessage: 'Settings',
});
const formatName = i18n.translate('components.addModule.guide.formatName', {
  defaultMessage: 'log_format',
});
const formatDescp = i18n.translate('components.addModule.guide.formatDescp', {
  defaultMessage: 'Set the format of the log to be read. field is required',
});
const formatPlace = i18n.translate('components.addModule.guide.formatPlace', {
  defaultMessage: 'audit',
});
const locName = i18n.translate('components.addModule.guide.locName', {
  defaultMessage: 'location',
});
const locDescp = i18n.translate('components.addModule.guide.locDescp', {
  defaultMessage:
    'Option to get the location of a log or a group of logs. strftime format strings may be used for log file names.',
});
const locPlace = i18n.translate('components.addModule.guide.locPlace', {
  defaultMessage: 'Log or group of logs location',
});
const locDefault = i18n.translate('components.addModule.guide.locDefault', {
  defaultMessage: '/var/log/audit/audit.log',
});
const commandName = i18n.translate('components.addModule.guide.commandName', {
  defaultMessage: 'command',
});
const commandDescp = i18n.translate('components.addModule.guide.commandDescp', {
  defaultMessage:
    'Given a command output, it will be read as one or more log messages depending on command or full_command is used.',
});
const commandPlace = i18n.translate('components.addModule.guide.commandPlace', {
  defaultMessage: 'Any command line, optionally including arguments',
});
const aliasName = i18n.translate('components.addModule.guide.aliasName', {
  defaultMessage: 'alias',
});
const aliasDescp = i18n.translate('components.addModule.guide.aliasDescp', {
  defaultMessage: 'Change a command name in the log message.',
});
const aliasPlace = i18n.translate('components.addModule.guide.aliasPlace', {
  defaultMessage: 'Alias',
});
const freName = i18n.translate('components.addModule.guide.freName', {
  defaultMessage: 'frequency',
});
const freDescp = i18n.translate('components.addModule.guide.freDescp', {
  defaultMessage:
...
const frePlace = i18n.translate('components.addModule.guide.frePlace', {
  defaultMessage: 'Frequency',
});
const freError = i18n.translate('components.addModule.guide.freError', {
  defaultMessage: 'Any positive number of seconds',
});
const eveName = i18n.translate('components.addModule.guide.eveName', {
  defaultMessage: 'only-future-events',
});
const eveDescp = i18n.translate('components.addModule.guide.eveDescp', {
  defaultMessage:
...
const tarName = i18n.translate('components.addModule.guide.tarName', {
  defaultMessage: 'target',
});
const tarDescp = i18n.translate('components.addModule.guide.tarDescp', {
  defaultMessage:
    'Target specifies the name of the socket where the output will be redirected. The socket must be defined previously.',
});
const tarDefault = i18n.translate('components.addModule.guide.tarDefault', {
  defaultMessage: 'agent',
});
const tarPlace = i18n.translate('components.addModule.guide.tarPlace', {
  defaultMessage: 'Any defined socket',
});
const outName = i18n.translate('components.addModule.guide.outName', {
  defaultMessage: 'out_format',
});
const outDescp = i18n.translate('components.addModule.guide.outDescp', {
  defaultMessage:
    'This option allows formatting logs from Logcollector using field substitution.',
});
const outInfo = i18n.translate('components.addModule.guide.outinfo', {
  defaultMessage:
...
const outPlace = i18n.translate('components.addModule.guide.outPlace', {
  defaultMessage: 'Formatting logs from Logcollector using field substitution',
});
const tar2Descp = i18n.translate('components.addModule.guide.tar2Descp', {
  defaultMessage:
    'This option selects a defined target to apply the output format',
});
const tar2Place = i18n.translate('components.addModule.guide.tar2Place', {
  defaultMessage: 'Any target defined in the option <target>.',
});
const ignName = i18n.translate('components.addModule.guide.ignName', {
  defaultMessage: 'ignore_binaries',
});
const ignDescp = i18n.translate('components.addModule.guide.ignDescp', {
  defaultMessage:
...
const ignInfo = i18n.translate('components.addModule.guide.igninfo', {
  defaultMessage:
    'On Windows agents, it will also check if the file is encoded with UCS-2 LE BOM or UCS-2 BE BOM.',
});
const ageName = i18n.translate('components.addModule.guide.ageName', {
  defaultMessage: 'age',
});
const ageDescp = i18n.translate('components.addModule.guide.ageDescp', {
  defaultMessage:
...
const agePlace = i18n.translate('components.addModule.guide.agePlace', {
  defaultMessage: 'Time in format <number><time unit suffix>',
});
const ageError = i18n.translate('components.addModule.guide.ageError', {
  defaultMessage:
...
const excName = i18n.translate('components.addModule.guide.excName', {
  defaultMessage: 'exclude',
});
const excDescp = i18n.translate('components.addModule.guide.excDescp', {
  defaultMessage:
...
const excPlace = i18n.translate('components.addModule.guide.excPlace', {
