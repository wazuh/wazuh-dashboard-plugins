...
const enabledName = i18n.translate('components.addModule.guide.enabledName', {
  defaultMessage: 'enabled',
});
const enabledDescp = i18n.translate('components.addModule.guide.enabledDescp', {
...
const runStartName = i18n.translate('components.addModule.guide.runStartName', {
  defaultMessage: 'run_on_start',
});
const runStartDescp = i18n.translate(
  'components.addModule.guide.runStartDescp',
  {
    defaultMessage:
...
const ignoreDescp = i18n.translate('components.addModule.guide.ignoreDescp', {
  defaultMessage:
    'Time during which vulnerabilities that have already been alerted will be ignored.',
});
const ignorePlace = i18n.translate('components.addModule.guide.ignorePlace', {
  defaultMessage: 'Time in format <number><time unit suffix>',
});
const ignoreDefault = i18n.translate(
  'components.addModule.guide.ignoreDefault',
  {
    defaultMessage: '6h',
  },
);
const ignoreError = i18n.translate('components.addModule.guide.ignoreError', {
  defaultMessage:
    'A positive number that should contain a suffix character indicating a time unit: s (seconds), m (minutes), h (hours) or d (days).',
});
...
const providerName = i18n.translate('components.addModule.guide.providerName', {
  defaultMessage: 'provider',
});
const providerDescp = i18n.translate(
  'components.addModule.guide.providerDescp',
  {
    defaultMessage: 'Configuration block to specify vulnerability updates.',
  },
);
const defineName = i18n.translate('components.addModule.guide.defineName', {
  defaultMessage: 'name',
});
const defineDescp = i18n.translate('components.addModule.guide.defineDescp', {
...
const providerDefaultVal = i18n.translate(
  'components.addModule.guide.providerDefaultVal',
  {
    defaultMessage: 'canonical',
  },
);
...
const osName = i18n.translate('components.addModule.guide.osName', {
  defaultMessage: 'os',
});
const osDescp = i18n.translate('components.addModule.guide.osDescp', {
  defaultMessage: 'Feed to update.',
});
const text5 = i18n.translate('components.addModule.guide.text5', {
  defaultMessage: 'canonical',
});
const text6 = i18n.translate('components.addModule.guide.text6', {
  defaultMessage: 'trusty',
});
const text7 = i18n.translate('components.addModule.guide.text7', {
  defaultMessage: 'bionic',
});
const text8 = i18n.translate('components.addModule.guide.text8', {
  defaultMessage: 'wheez',
});
const text9 = i18n.translate('components.addModule.guide.text9', {
  defaultMessage: 'canonical',
});
const text10 = i18n.translate('components.addModule.guide.text10', {
  defaultMessage: 'stretch',
});
const text11 = i18n.translate('components.addModule.guide.text11', {
  defaultMessage: 'redhat',
});
const text12 = i18n.translate('components.addModule.guide.text12', {
  defaultMessage: 'buster',
});
const preciseDefaultVal = i18n.translate(
  'components.addModule.guide.preciseDefaultVal',
  {
    defaultMessage: 'precise',
  },
);
const updateName = i18n.translate('components.addModule.guide.updateName', {
  defaultMessage: 'update_interval',
});
const updateDescp = i18n.translate('components.addModule.guide.updateDescp', {
  defaultMessage:
    'How often the vulnerability database is updated. It has priority over the update_interval option of the provider block.',
});
const updateError = i18n.translate('components.addModule.guide.updateError', {
  defaultMessage:
    'A positive number that should contain a suffix character indicating a time unit: s (seconds), m (minutes), h (hours) or d (days).',
});
const urlName = i18n.translate('components.addModule.guide.urlName', {
  defaultMessage: 'url',
});
const urlDescp = i18n.translate('components.addModule.guide.urlDescp', {
  defaultMessage: 'Defines the link to an alternative OVAL files.',
});
const urlPlace = i18n.translate('components.addModule.guide.urlPlace', {
  defaultMessage:
...
const portName = i18n.translate('components.addModule.guide.portName', {
  defaultMessage: 'port',
});
const portDescp = i18n.translate('components.addModule.guide.portDescp', {
  defaultMessage: 'Defines the connection port when using the url attribute.',
});
const portError = i18n.translate('components.addModule.guide.portError', {
  defaultMessage: 'A valid port.',
});
const allowName = i18n.translate('components.addModule.guide.allowName', {
  defaultMessage: 'allow',
});
const allowDescp = i18n.translate('components.addModule.guide.allowDescp', {
  defaultMessage: 'Defines compatibility with unsupported systems.',
});
const allowError = i18n.translate('components.addModule.guide.allowError', {
  defaultMessage: 'A valid operating system not supported by default.',
});
const updateIntervalName = i18n.translate(
  'components.addModule.guide.updateIntervalName',
  {
    defaultMessage: 'update_interval',
  },
);
const updateIntervalDescp = i18n.translate(
  'components.addModule.guide.updateIntervalDescp',
  {
    defaultMessage:
...
const updateIntervalPlace = i18n.translate(
  'components.addModule.guide.updateIntervalPlace',
  {
    defaultMessage:
      'A positive number that should contain a suffix character indicating a time unit: s (seconds), m (minutes), h (hours) or d (days).',
  },
...
const updateIntervalError = i18n.translate(
  'components.addModule.guide.updateIntervalError',
  {
    defaultMessage:
      'A positive number that should contain a suffix character indicating a time unit: s (seconds), m (minutes), h (hours) or d (days).',
  },
...
const replaceOsPlace = i18n.translate(
  'components.addModule.guide.replaceOsPlace',
  {
    defaultMessage:
...
const replaceOsError = i18n.translate(
  'components.addModule.guide.replaceOsError',
  {
    defaultMessage:
      'A numeric value that in substitution with the tag forms a valid link.',
  },
...
const defineUrlName = i18n.translate(
  'components.addModule.guide.defineUrlName',
  {
    defaultMessage: 'url',
  },
);
const defineUrlDescp = i18n.translate(
  'components.addModule.guide.defineUrlDescp',
  {
    defaultMessage: 'Defines the link to an alternative feed files.',
  },
);
const defineUrlPlace = i18n.translate(
  'components.addModule.guide.defineUrlPlace',
  {
    defaultMessage: 'Defines the link to an alternative feed files.',
  },
);
const startName = i18n.translate('components.addModule.guide.startName', {
  defaultMessage: 'start',
});
const startDescp = i18n.translate('components.addModule.guide.startDescp', {
  defaultMessage: 'Defines the first value which the tag will be substituted.',
});
const startPlace = i18n.translate('components.addModule.guide.startPlace', {
  defaultMessage:
    'A numeric value that in substitution with the tag forms a valid link.',
});
const startError = i18n.translate('components.addModule.guide.startError', {
  defaultMessage:
    'A numeric value that in substitution with the tag forms a valid link.',
});
const endName = i18n.translate('components.addModule.guide.endName', {
  defaultMessage: 'end',
});
const endDescp = i18n.translate('components.addModule.guide.endDescp', {
  defaultMessage: 'Defines the last which the tag will be substituted.',
});
const connectionPortName = i18n.translate(
  'components.addModule.guide.connectionPortName',
  {
    defaultMessage: 'port',
  },
);
const connectionPortDescp = i18n.translate(
  'components.addModule.guide.connectionPortDescp',
  {
    defaultMessage: 'Defines the connection port.',
  },
);
const connectionPortPlace = i18n.translate(
  'components.addModule.guide.connectionPortPlace',
  {
    defaultMessage: 'A valid port.',
  },
);
const connectionPortError = i18n.translate(
  'components.addModule.guide.connectionPortError',
  {
    defaultMessage: 'A valid port.',
  },
);
const allFeedName = i18n.translate('components.addModule.guide.allFeedName', {
  defaultMessage: 'path',
});
const allFeedDescp = i18n.translate('components.addModule.guide.allFeedDescp', {
  defaultMessage: 'Defines the path to an alternative feed files.',
});
const allFeedPlace = i18n.translate('components.addModule.guide.allFeedPlace', {
