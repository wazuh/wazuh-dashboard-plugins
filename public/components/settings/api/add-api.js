...
const notReachable = i18n.translate(
  'wazuh.public.components.settings.api.notReachable',
  {
    defaultMessage: 'Wazuh API not reachable, please review your configuration',
  },
);
    ...
    checkErrorsAtInit() {
      if (this.props.errorsAtInit) {
        ...
        this.setState({
          ...
          blockClose: true,
          message: (error.data || error).message || notReachable,
          fetchingData: false,
        });
      }
    }
    ...
    async checkConnection() {
      ...
      try {
        ...
        this.setState({
          ...
          blockClose: !close,
          enableClose: false,
          message: (error.data || error).message || error || notReachable,
          fetchingData: false,
        });
        ...
        <div>
          ...
          <EuiText>
            ...
            {i18n.translate('wazuh.components.settings.api.context', {
              defaultMessage:
                "defines if the app user's permissions depends on the authentication context ",
            })}
