...
const mainSettings = [
  ...
  { field: 'custom_alert_output', label: 'Customized alerts format for alerts.log file' },
...
const emailSettings = [
  ...
  { field: 'email_maxperhour', label: 'Maximum number of email alerts sent per hour'},
...
const otherSettings = [
  ...
  { field: 'geoip_db_path', label: 'Full path to MaxMind GeoIP IPv4 database file'}
];
  ...
  render(){
    ...
    return (
      <Fragment>
        ...
        {((currentConfig['analysis-global'] && currentConfig['analysis-global'].global) || (currentConfig['com-logging'] && currentConfig['com-logging'].logging)) && (
