    ...
    return (
      <Fragment>
        {(this.props.onlyShowTab === 'Policy Monitoring' && (
          ...
          || (this.props.onlyShowTab === 'System audit' && (<WzConfigurationPolicyMonitoringSystemAudit {...this.props} />))
          || (this.props.onlyShowTab === 'SCA' && (<WzConfigurationPolicyMonitoringSCA {...this.props} />))
          || (
            <WzTabSelector>
              <WzTabSelectorTab label='General'>
                <WzConfigurationPolicyMonitoringGeneral {...this.props} />
