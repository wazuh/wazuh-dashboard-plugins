...
const sections = [{component:'analysis',configuration:'logging'},{component:'monitor',configuration:'logging'}];

const sectionsAgent = [{component:'agent',configuration:'logging', scope: 'null', agentId: 'true'}];
