...
class WzConfigurationLogSettingsArchives extends Component{
  ...
  render(){
    ...
    return (
     <Fragment>
       {currentConfig['analysis-logging'] && isString(currentConfig['analysis-logging']) && (
         <Fragment>
           <WzNoConfig error={currentConfig['analysis-logging']} help={helpLinks}/>
         </Fragment>
       )}
       {(currentConfig['analysis-logging'] && currentConfig['analysis-logging'].logging) || (currentConfig['com-logging'] && currentConfig['com-logging'].logging) && (
         <WzConfigurationSettingsTabSelector
            title='Archives settings'
            description='Basic archives log settings'
            currentConfig={currentConfig['analysis-logging'].logging.archives}
            helpLinks={helpLinks}
          >
