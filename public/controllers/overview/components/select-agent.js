...
export const SelectAgent = withErrorBoundary(
      ...
      return [
        {
          field: 'name',
          name: i18n.translate(
            'wazuh.public.controller.overview.components.select.agent.Name',
            {
              defaultMessage: 'Name',
            },
          ),
        ...
        },
        {
          field: 'ip',
          name: i18n.translate(
            'wazuh.public.controller.overview.components.select.agent.IP',
            {
              defaultMessage: 'IP',
            },
          ),
        ...
        },
        {
          field: 'group',
          name: i18n.translate(
            'wazuh.public.controller.overview.components.select.agent.Group',
            {
        ...
        },
        {
          field: 'version',
          name: i18n.translate(
            'wazuh.public.controller.overview.components.select.agent.Version',
            {
        ...
        },
        {
          field: 'dateAdd',
          name: i18n.translate(
            'wazuh.public.controller.overview.components.select.agent.Registrationdate',
            {
        ...
        },
        {
          field: 'lastKeepAlive',
          name: i18n.translate(
            'wazuh.public.controller.overview.components.select.agent.Lastkeepalive',
            {
        ...
        },
        {
          field: 'status',
          name: i18n.translate(
            'wazuh.public.controller.overview.components.select.agent.Status',
            {
          ...
          >
            <EuiFlyoutHeader hasBorder>
              <EuiTitle size='m'>
                <h2 id='flyoutTitle'>
                  {i18n.translate(
                    'wazuh.public.controller.overview.components.select.agent.Selectagent',
                    {
