...
import { API_NAME_AGENT_STATUS, UI_ORDER_AGENT_STATUS, AGENT_SYNCED_STATUS } from '../../../../common/constants';
...
export const AgentsTable = withErrorBoundary(
  class AgentsTable extends Component {
    ...
    constructor(props) {
      super(props);
      this.state = {
        // filters: sessionStorage.getItem('wz-agents-overview-table-filter') // TODO:
            ...
            <TableWzAPI
              ...
              searchBarWQL={{
                ...
                suggestions: {
                  field(currentValue) {
                    return [
                      {label: 'dateAdd', description: 'filter by registration date'},
                    ...
                    try{
                      switch (field) {
                        ...
                        case 'group_config_status':
                          return [AGENT_SYNCED_STATUS.SYNCED, AGENT_SYNCED_STATUS.NOT_SYNCED].map((label) => {label});
                          break;
                        default:
