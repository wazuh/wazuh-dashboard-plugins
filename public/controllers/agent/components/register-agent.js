  ...
  class RegisterAgent extends Component {
    ...
    resolveRPMPackage() {
      switch (
        ...
        case 'redhat5-i386':
          return `https://packages.wazuh.com/4.x/yum5/i386/wazuh-agent-${this.state.wazuhVersion}${addToVersion}.el5.i386.rpm`;
        case 'redhat5-x86_64':
          return `https://packages.wazuh.com/4.x/yum5/x86_64/wazuh-agent-${this.state.wazuhVersion}${addToVersion}.el5.x86_64.rpm`;
        case 'redhat6-i386':
          return `https://packages.wazuh.com/4.x/yum/wazuh-agent-${this.state.wazuhVersion}${addToVersion}.i386.rpm`;
        case 'redhat6-aarch64':
          return `https://packages.wazuh.com/4.x/yum/wazuh-agent-${this.state.wazuhVersion}${addToVersion}.aarch64.rpm`;
        case 'redhat6-x86_64':
          return `https://packages.wazuh.com/4.x/yum/wazuh-agent-${this.state.wazuhVersion}${addToVersion}.x86_64.rpm`;
        case 'redhat6-armhf':
          return `https://packages.wazuh.com/4.x/yum/wazuh-agent-${this.state.wazuhVersion}${addToVersion}.armv7hl.rpm`;
        case 'redhat7-i386':
          return `https://packages.wazuh.com/4.x/yum/wazuh-agent-${this.state.wazuhVersion}${addToVersion}.i386.rpm`;
        ...
        case 'redhat7-powerpc':
          return `https://packages.wazuh.com/4.x/yum/wazuh-agent-${this.state.wazuhVersion}${addToVersion}.ppc64le.rpm`;
        default:
          return `https://packages.wazuh.com/4.x/yum/wazuh-agent-${this.state.wazuhVersion}${addToVersion}.x86_64.rpm`;
      }
    }
    ...
    resolveCENTPackage() {
      switch (
        ...
        case 'centos5-i386':
          return `https://packages.wazuh.com/4.x/yum/i386/wazuh-agent-${this.state.wazuhVersion}${addToVersion}.el5.i386.rpm`;
        case 'centos5-x86_64':
          return `https://packages.wazuh.com/4.x/yum/x86_64/wazuh-agent-${this.state.wazuhVersion}${addToVersion}.el5.x86_64.rpm`;
        case 'centos6-i386':
          return `https://packages.wazuh.com/4.x/yum/wazuh-agent-${this.state.wazuhVersion}${addToVersion}.i386.rpm`;
    ...
    resolveDEBPackage() {
      switch (`${this.state.selectedArchitecture}`) {
        case 'i386':
          return `https://packages.wazuh.com/4.x/apt/pool/main/w/wazuh-agent/wazuh-agent_${this.state.wazuhVersion}${addToVersion}_i386.deb`;
        case 'aarch64':
          return `https://packages.wazuh.com/4.x/apt/pool/main/w/wazuh-agent/wazuh-agent_${this.state.wazuhVersion}${addToVersion}_arm64.deb`;
        case 'armhf':
          return `https://packages.wazuh.com/4.x/apt/pool/main/w/wazuh-agent/wazuh-agent_${this.state.wazuhVersion}${addToVersion}_armhf.deb`;
        case 'x86_64':
          return `https://packages.wazuh.com/4.x/apt/pool/main/w/wazuh-agent/wazuh-agent_${this.state.wazuhVersion}${addToVersion}_amd64.deb`;
        case 'powerpc':
          return `https://packages.wazuh.com/4.x/apt/pool/main/w/wazuh-agent/wazuh-agent_${this.state.wazuhVersion}${addToVersion}.ppc64el.deb`;
        default:
          return `https://packages.wazuh.com/4.x/apt/pool/main/w/wazuh-agent/wazuh-agent_${this.state.wazuhVersion}${addToVersion}_amd64.deb`;
      }
    }
    ...
    resolveOPENSUSEPackage() {
      switch (
        ...
        case 'leap15-x86_64':
          return `https://packages.wazuh.com/4.x/yum/i386/wazuh-agent-${this.state.wazuhVersion}${addToVersion}.x86_64.rpm`;
        case 'leap15-ARM64':
          return `https://packages.wazuh.com/4.x/yum/x86_64/wazuh-agent-${this.state.wazuhVersion}${addToVersion}.armv7hl.rpm`;
        default:
          return `https://packages.wazuh.com/4.x/yum/wazuh-agent-${this.state.wazuhVersion}${addToVersion}.x86_64.rpm`;
      }
    }
    ...
    resolveAIXPackage() {
      switch (
        ...
        case '6.1 TL9-powerpc':
          return `https://packages.wazuh.com/4.x/yum/i386/wazuh-agent-${this.state.wazuhVersion}${addToVersion}.aix.ppc.rpm`;
        default:
          return `https://packages.wazuh.com/4.x/yum/i386/wazuh-agent-${this.state.wazuhVersion}${addToVersion}.aix.ppc.rpm`;
      }
    }
    ...
    resolveHPPackage() {
      switch (
        ...
        case '11.31-itanium2':
          return `https://packages.wazuh.com/4.x/yum/i386/wazuh-agent-${this.state.wazuhVersion}${addToVersion}-hpux-11v3-ia64.tar`;
        default:
          return `https://packages.wazuh.com/4.x/yum/i386/wazuh-agent-${this.state.wazuhVersion}${addToVersion}-hpux-11v3-ia64.tar`;
      }
    }
...
apk add wazuh-agent`,
        ...
        solText: `sudo curl -so ${this.optionalPackages()} && sudo && ${
          this.state.selectedVersion == 'solaris11'
