...
var visualizations = {
    ...
    TopGroups: {type: 'table', data: "vis:(aggs:!((id:'1',params:(),schema:metric,type:count),(id:'2',params:(field:rule.groups,order:desc,orderBy:'1',size:10),schema:bucket,type:terms)),listeners:(),params:(perPage:10,showMeticsAtAllLevels:!f,showPartialRows:!f),title:'Top$2010$20groups',type:table))"},
