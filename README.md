...
| Wazuh app version | Kibana version | Open Distro version | Package                                                         |
| :---------------: | :------------: | :-----------------: | :-------------------------------------------------------------- |
...
|       3.9.3       |      7.0.1     | 1.0.0, 1.0.1, 1.0.2 | <https://packages.wazuh.com/wazuhapp/wazuhapp-3.9.3_7.0.1.zip>  |
