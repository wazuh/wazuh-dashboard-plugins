...
```
cd /usr/share/kibana
sudo -u kibana bin/kibana-plugin install https://packages.wazuh.com/wazuhapp/wazuhapp-3.13.3_7.9.2.zip
```
...
|   3.13.3  |  7.8.0 |             | <https://packages.wazuh.com/wazuhapp/wazuhapp-3.13.3_7.8.0.zip> |
