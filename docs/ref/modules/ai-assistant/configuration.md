...
that need no API key can still be saved, and keys stored in plaintext by earlier pre-release
builds remain readable. Neither the key nor any derived material is ever exposed to the browser
