...
| Name                                                                | Description                                                                                                                                                                                                                |
| ------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `index-pattern:active-responses`                                    | Validate (create if possible) the existence of a compatible index pattern for active responses                                                                                                                             |
...
| `index-pattern:events-unclassified`                                 | Validate (create if possible) the existence of a compatible index pattern for unclassified events                                                                                                                          |
| `index-pattern:events-raw`                                          | Validate (create if possible) the existence of a compatible index pattern for raw events                                                                                                                                   |
| `index-pattern:findings`                                            | Validate (create if possible) the existence of a compatible index pattern for findings                                                                                                                                     |
| `index-pattern:findings-access-management`                          | Validate (create if possible) the existence of a compatible index pattern for access management findings                                                                                                                   |
| `index-pattern:findings-applications`                               | Validate (create if possible) the existence of a compatible index pattern for applications findings                                                                                                                        |
| `index-pattern:findings-cloud-services`                             | Validate (create if possible) the existence of a compatible index pattern for cloud services findings                                                                                                                      |
| `index-pattern:findings-network-activity`                           | Validate (create if possible) the existence of a compatible index pattern for network activity findings                                                                                                                    |
| `index-pattern:findings-other`                                      | Validate (create if possible) the existence of a compatible index pattern for other findings                                                                                                                               |
| `index-pattern:findings-security`                                   | Validate (create if possible) the existence of a compatible index pattern for security findings                                                                                                                            |
| `index-pattern:findings-system-activity`                            | Validate (create if possible) the existence of a compatible index pattern for system activity findings                                                                                                                     |
| `index-pattern:findings-unclassified`                               | Validate (create if possible) the existence of a compatible index pattern for unclassified findings                                                                                                                        |
| `index-pattern:metrics-agents`                                      | Validate (create if possible) the existence of a compatible index pattern for agent metrics                                                                                                                                |
| `index-pattern:metrics-comms`                                       | Validate (create if possible) the existence of a compatible index pattern for server metrics                                                                                                                               |
...
```log
<<<<<<< HEAD
server    log   [10:52:31.480] [info][healthcheck] Enabled checks [48]: [integrations:default-notifications-channels-and-alerting-monitors,server-api:connection-compatibility,server-api:run-as,saved-objects:dashboards,index-pattern:metrics-agents,index-pattern:metrics-comms,index-pattern:states-vulnerabilities,index-pattern:states-inventory,index-pattern:states-inventory-groups,index-pattern:states-inventory-hardware,index-pattern:states-inventory-hotfixes,index-pattern:states-inventory-interfaces,index-pattern:states-inventory-networks,index-pattern:states-inventory-packages,index-pattern:states-inventory-ports,index-pattern:states-inventory-processes,index-pattern:states-inventory-protocols,index-pattern:states-inventory-system,index-pattern:states-inventory-users,index-pattern:states-inventory-services,index-pattern:states-inventory-browser-extensions,index-pattern:states-fim-files,index-pattern:states-fim-registry-keys,index-pattern:states-fim-registry-values,index-pattern:states-sca,index-pattern:events-system-activity,index-pattern:events-security,index-pattern:events-access-management,index-pattern:events-applications,index-pattern:events-other,index-pattern:events-network-activity,index-pattern:events-cloud-services,index-pattern:events-cloud-services-azure,index-pattern:events-cloud-services-gcp,index-pattern:events,index-pattern:active-responses,index-pattern:events-unclassified,index-pattern:events-raw,index-pattern:findings,index-pattern:findings-system-activity,index-pattern:findings-security,index-pattern:findings-access-management,index-pattern:findings-applications,index-pattern:findings-other,index-pattern:findings-network-activity,index-pattern:findings-cloud-services,index-pattern:findings-unclassified]
=======
server    log   [10:52:31.480] [info][healthcheck] Enabled checks [48]: [integrations:default-notifications-channels-and-alerting-monitors,server-api:connection-compatibility,server-api:run-as,saved-objects:dashboards,index-pattern:metrics-agents,index-pattern:metrics-comms,index-pattern:states-vulnerabilities,index-pattern:states-inventory,index-pattern:states-inventory-groups,index-pattern:states-inventory-hardware,index-pattern:states-inventory-hotfixes,index-pattern:states-inventory-interfaces,index-pattern:states-inventory-networks,index-pattern:states-inventory-packages,index-pattern:states-inventory-ports,index-pattern:states-inventory-processes,index-pattern:states-inventory-protocols,index-pattern:states-inventory-system,index-pattern:states-inventory-users,index-pattern:states-inventory-services,index-pattern:states-inventory-browser-extensions,index-pattern:states-fim-files,index-pattern:states-fim-registry-keys,index-pattern:states-fim-registry-values,index-pattern:states-sca,index-pattern:events-system-activity,index-pattern:events-security,index-pattern:events-access-management,index-pattern:events-applications,index-pattern:events-other,index-pattern:events-network-activity,index-pattern:events-cloud-services,index-pattern:events-cloud-services-gcp,index-pattern:events,index-pattern:active-responses,index-pattern:events-unclassified,index-pattern:events-raw,index-pattern:findings,index-pattern:findings-system-activity,index-pattern:findings-security,index-pattern:findings-access-management,index-pattern:findings-applications,index-pattern:findings-other,index-pattern:findings-network-activity,index-pattern:findings-cloud-services,index-pattern:findings-unclassified]
>>>>>>> 71b8e22c7337d71e1aae2ce2c81590d0cd31a07c
```
