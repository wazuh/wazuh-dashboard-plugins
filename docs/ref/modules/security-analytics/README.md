...
| **Standard** | Wazuh      | Contains the built-in integrations, decoders, and rules shipped with Wazuh. This content is read-only; only the space policy's enrichments and indexing settings can be adjusted. |
