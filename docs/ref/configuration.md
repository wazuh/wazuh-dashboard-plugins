...
| `opensearch_security_analytics.disabledSettings`    | Define which Security Analytics settings are hidden from the UI                                                        | `[]`              | list of: `index-discarded-events`, `index-unclassified-events`, `index-raw-events` |
