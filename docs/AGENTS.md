...
The documentation should focus on **Wazuh Dashboard as an independent product or application**, and not only at the level of Wazuh *plugins* or excessive references to OpenSearch.
...
| **Commands** | Avoid colloquial terms like "**paste**". It is suggested to use "Replace the *placeholder* with..." or a more formal equivalent. |
