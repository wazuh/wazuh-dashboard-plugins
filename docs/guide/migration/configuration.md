...
If your deployment had dashboards or alerts that depended on either index, those will need to be rebuilt against the new data model (`wazuh-metrics-comms-v4` and `wazuh-metrics-agents` indices).
