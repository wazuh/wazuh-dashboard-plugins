...
- Added Wazuh AI Assistant plugin: provider-agnostic AI chat over Wazuh data with a read-only tool catalog, server-side guardrails, optional pseudonymization, and API-key encryption at rest [#8788](https://github.com/wazuh/wazuh-dashboard-plugins/pull/8788) [#8797](https://github.com/wazuh/wazuh-dashboard-plugins/issues/8797) [8802](https://github.com/wazuh/wazuh-dashboard-plugins/issues/8802) [#8799](https://github.com/wazuh/wazuh-dashboard-plugins/issues/8799)
...
- Fixed the AI Assistant app not managing the view routing, so refreshing the page always returned to the Chat tab [#8820](https://github.com/wazuh/wazuh-dashboard-plugins/issues/8820)
