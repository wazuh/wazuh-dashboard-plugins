...
- Added a final step that redirects to the agent list to verify the agent connection in the Deploy new agent section [#7711](https://github.com/wazuh/wazuh-dashboard-plugins/pull/7711)
