...
- Implement try catch strategy ManagementController [#3374](https://github.com/wazuh/wazuh-kibana-app/pull/3374)
- Refactor try catch in Management > Ruleset [#3410](https://github.com/wazuh/wazuh-kibana-app/pull/3410)
