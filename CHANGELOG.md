...
## Wazuh v5.0.0 - OpenSearch Dashboards 3.0.0 - Revision 00
...
- Fixed missing CI workflows from 6.0.0 to `main` branch [#7508](https://github.com/wazuh/wazuh-dashboard-plugins/pull/7508)
...
- Added `It Hygiene` application [#7368](https://github.com/wazuh/wazuh-dashboard-plugins/pull/7368) [#7461](https://github.com/wazuh/wazuh-dashboard-plugins/pull/7461) [#7476](https://github.com/wazuh/wazuh-dashboard-plugins/pull/7476)
