...
- Added Wazuh AI Assistant plugin: provider-agnostic AI chat over Wazuh data with a read-only tool catalog, server-side guardrails, optional pseudonymization, and API-key encryption at rest [#8788](https://github.com/wazuh/wazuh-dashboard-plugins/pull/8788) [#8789](https://github.com/wazuh/wazuh-dashboard-plugins/issues/8789) [#8815](https://github.com/wazuh/wazuh-dashboard-plugins/pull/8815)
