...
- fixed the error that when restarting the manager after editing the configuration the error "API not available" is displayed [#4264](https://github.com/wazuh/wazuh-kibana-app/pull/4264)
