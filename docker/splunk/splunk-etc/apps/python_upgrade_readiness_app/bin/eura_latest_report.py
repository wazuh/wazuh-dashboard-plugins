...
logging = logger_manager.setup_logging('eura_latest_report')
...
class LatestReportHandler(PersistentServerConnectionApplication):
    ...
    def handle(self, in_string):
        ...
        try:
            ...
            app_names = query_params["eura_apps"]
    ...
    def get_latest_report(self):
        ...
        latest_report_path = os.path.join(EMERALD_REPORT_PATH, latest_report)
        latest_report_data = {}
