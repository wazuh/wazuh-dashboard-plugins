...
class ManageEmailSwitchHandler(PersistentServerConnectionApplication):
    ...
    def handle(self, in_string):
        ...
        try:
            ...
            if method.lower() == "get":
                is_pra_email_enabled = int(str(query_params.get("is_pra_email_enabled", "1")))
                is_jra_email_enabled = int(str(query_params.get("is_jra_email_enabled", "1")))

                email_switch_details = dict()
                email_switch_details["is_pra_email_enabled"] = is_pra_email_enabled
                email_switch_details["is_jra_email_enabled"] = is_jra_email_enabled
