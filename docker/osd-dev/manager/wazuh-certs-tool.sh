...
# ------------------------------------------------------------------------------
# OSD-DEV: verbatim copy of the Wazuh manager devcontainer certificate tool.
#
#   Origin : wazuh/wazuh, src/engine/tools/devContainer/scripts/wazuh-certs-tool.sh
#   Commit : 37e3826b3f409361f741ff490b4db9e7ea9f90ff
#   URL    : https://github.com/wazuh/wazuh/blob/37e3826b3f409361f741ff490b4db9e7ea9f90ff/src/engine/tools/devContainer/scripts/wazuh-certs-tool.sh
#
# This header is the only local change; the body below is byte-identical to the
# pinned commit, so refreshing it is a plain download plus this block. The
# manager entrypoint calls it with -wm and the root CA the "generator" service
# publishes, never -A: that CA is the trust anchor the indexer, the dashboard,
# imposter and the agents already share.
# ------------------------------------------------------------------------------
