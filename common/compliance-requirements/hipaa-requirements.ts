...
const technicalPolicies = i18n.translate('complianceRequirements.hipaa.technicalPolicy', {
  defaultMessage:
...
const uniqueName = i18n.translate('complianceRequirements.hipaa.uniqueName', {
  defaultMessage:
    'Assign a unique name and/or number for identifying and tracking user identity.',
});
const healthInformation = i18n.translate('complianceRequirements.hipaa.healthInformation', {
  defaultMessage:
    'Establish (and implement as needed) procedures for obtaining necessary electronic protected health information during an emergency.',
  },
);
const electronicProcedure = i18n.translate(
  'complianceRequirements.hipaa.electronicProcedure',
  {
    defaultMessage:
...
const encryptAndDecryptHealthInfo = i18n.translate(
  'complianceRequirements.hipaa.encryptAndDecryptHealthInfo',
  {
    defaultMessage:
...
const hardwareAndSoftwareMechanism = i18n.translate(
  'complianceRequirements.hipaa.hardwareAndSoftwareMechanism',
  {
    defaultMessage:
...
const protectFromAlterationOrDestruction = i18n.translate(
  'complianceRequirements.hipaa.protectFromAlterationOrDestruction',
  {
    defaultMessage:
...
const electronicMechanismsToProtectFromAlteration = i18n.translate(
  'complianceRequirements.hipaa.electronicMechanismsToProtectFromAlteration',
  {
    defaultMessage:
      'Implement electronic mechanisms to corroborate that electronic protected health information has not been altered or destroyed in an unauthorized manner.',
  },
);
const seekAccess = i18n.translate('complianceRequirements.hipaa.seekAccess', {
  defaultMessage:
...
const technicalSecurityMeasures = i18n.translate(
  'complianceRequirements.hipaa.technicalSecurityMeasures',
  {
    defaultMessage:
...
const securityDetection = i18n.translate('complianceRequirements.hipaa.securityDetection', {
  defaultMessage:
    'Implement security measures to ensure that electronically transmitted electronic protected health information is not improperly modified without detection until disposed of.',
});

const deemedAppropriate = i18n.translate(
  'complianceRequirements.hipaa.deemedAppropriate',
  {
    defaultMessage:
