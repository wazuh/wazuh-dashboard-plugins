 ...
 */
 ...
 const ac2 = i18n.translate('complianceRequirements.nist.ac2', {
	 defaultMessage:
 ...
 const ac6 = i18n.translate('complianceRequirements.nist.ac6', {
	 defaultMessage:
 ...
 const ac12 = i18n.translate('complianceRequirements.nist.ac12', {
	...
	const au6 = i18n.translate('complianceRequirements.nist.au66', {
		defaultMessage:
			'AUDIT REVIEW, ANALYSIS, AND REPORTING - Reviews and analyzes information system audit records.',
	});

	const au8 = i18n.translate('complianceRequirements.nist.au8', {
		defaultMessage:
	...
	const au9 = i18n.translate('complianceRequirements.nist.au9', {
		defaultMessage:
	...
	const au12 = i18n.translate('complianceRequirements.nist.au12', {
		defaultMessage:
	...
	const ca3 = i18n.translate('complianceRequirements.nist.ca3', {
		defaultMessage:
	...
	const cm1 = i18n.translate('complianceRequirements.nist.cm1', {
		defaultMessage:
	...
	const cm3 = i18n.translate('complianceRequirements.nist.cm3', {
		defaultMessage:
	...
	const cm5 = i18n.translate('complianceRequirements.nist.cm5', {
		defaultMessage:
	...
	const ia4 = i18n.translate('complianceRequirements.nist.ia4', {
		defaultMessage:
	...
	const ia5 = i18n.translate('complianceRequirements.nist.ia5', {
		defaultMessage:
	...
	const ia10 = i18n.translate('complianceRequirements.nist.ia10', {
		defaultMessage:
	...
	const sa11 = i18n.translate('complianceRequirements.nist.sa11', {
		defaultMessage:
	...
	const sc2 = i18n.translate('complianceRequirements.nist.sc2', {
		defaultMessage:
	...
	const sc7 = i18n.translate('complianceRequirements.nist.sc7', {
		defaultMessage:
	...
	const sc8 = i18n.translate('complianceRequirements.nist.sc8', {
		defaultMessage:
	...
	const si2 = i18n.translate('complianceRequirements.nist.si2', {
    defaultMessage:
	...
	const si3 = i18n.translate('complianceRequirements.nist.si3', {
    defaultMessage:
	...
	const si7 = i18n.translate('complianceRequirements.nist.si7', {
    defaultMessage:
