...
const networkConnection = i18n.translate(
  'wazuh.complianceRequirements.pci.networkConnection',
  {
    defaultMessage:
...
const unauthorizedTraffic = i18n.translate(
  'wazuh.complianceRequirements.pci.unauthorizedTraffic',
  {
    defaultMessage:
...
const personalFirewall = i18n.translate(
  'wazuh.complianceRequirements.pci.personalFirewall',
  {
    defaultMessage:
...
const configurationStandards = i18n.translate(
  'wazuh.complianceRequirements.pci.configurationStandards',
  {
    defaultMessage:
...
const enableNecessaryServices = i18n.translate(
  'wazuh.complianceRequirements.pci.enableNecessaryServices',
  {
    defaultMessage:
...
const additionalSecurityFeatures = i18n.translate(
  'wazuh.complianceRequirements.pci.additionalSecurityFeatures',
  {
    defaultMessage:
...
const securityParameters = i18n.translate(
  'wazuh.complianceRequirements.pci.securityParameters',
  {
...
const strongCryptography = i18n.translate(
  'wazuh.complianceRequirements.pci.strongCryptography',
  {
    defaultMessage:
...
const antiVirusSoftwares = i18n.translate(
  'wazuh.complianceRequirements.pci.antiVirusSoftwares',
  {
    defaultMessage:
...
const antiVirusMechanisms = i18n.translate(
  'wazuh.complianceRequirements.pci.antiVirusMechanisms',
  {
    defaultMessage:
...
const systemComponents = i18n.translate(
  'wazuh.complianceRequirements.pci.systemComponents',
  {
    defaultMessage:
...
const vulnerabilities1 = i18n.translate(
  'wazuh.complianceRequirements.pci.vulnerabilities',
  {
    defaultMessage:
...
const injectionFlaws = i18n.translate(
  'wazuh.complianceRequirements.pci.injectionFlaws',
  {
    defaultMessage:
...
const bufferOverflow = i18n.translate(
  'wazuh.complianceRequirements.pci.bufferOverflow',
  {
...
const improperErrorHandling = i18n.translate(
  'wazuh.complianceRequirements.pci.improperErrorHandling',
  {
...
const crossSiteScripting = i18n.translate(
  'wazuh.complianceRequirements.pci.crossSiteScripting',
  {
    defaultMessage: 'Cross-site scripting (XSS)',
  },
);
const descp1 = i18n.translate('wazuh.common.compliance.req.pcidescp1', {
  defaultMessage:
...
const descp2 = i18n.translate('wazuh.common.compliance.req.pcidescp2', {
  defaultMessage: 'Broken authentication and session management.',
});
const descp3 = i18n.translate('wazuh.common.compliance.req.pcidescp3', {
  defaultMessage:
...
const descp4 = i18n.translate('wazuh.common.compliance.req.pcidescp4', {
  defaultMessage:
    'DControl addition, deletion, and modification of user IDs, credentials, and other identifier objects.',
});
const descp5 = i18n.translate('wazuh.common.compliance.req.pcidescp5', {
  defaultMessage: 'Remove/disable inactive user accounts within 90 days.',
});
const descp6 = i18n.translate('wazuh.common.compliance.req.pcidescp6', {
  defaultMessage:
...
const descp7 = i18n.translate('wazuh.common.compliance.req.pcidescp7', {
  defaultMessage:
    'Limit repeated access attempts by locking out the user ID after not more than six attempts.',
});
const descp8 = i18n.translate('wazuh.common.compliance.req.pcidescp8', {
  defaultMessage:
...
const descp9 = i18n.translate('wazuh.common.compliance.req.pcidescp9', {
  defaultMessage:
    'Change user passwords/passphrases at least once every 90 days.',
});
const descp10 = i18n.translate('wazuh.common.compliance.req.pci.descp10', {
  defaultMessage:
...
const descp11 = i18n.translate('wazuh.common.compliance.req.pci.descp11', {
  defaultMessage:
...
const descp12 = i18n.translate('wazuh.common.compliance.req.pci.descp12', {
  defaultMessage:
    'Implement audit trails to link all access to system components to each individual user.',
});
const descp13 = i18n.translate('wazuh.common.compliance.req.pci.descp13', {
  defaultMessage: 'All individual user accesses to cardholder data',
});
const descp14 = i18n.translate('wazuh.common.compliance.req.pci.descp14', {
  defaultMessage:
    'All actions taken by any individual with root or administrative privileges.',
});
const descp15 = i18n.translate('wazuh.common.compliance.req.pci.descp15', {
  defaultMessage: 'Invalid logical access attempts',
});
const descp16 = i18n.translate('wazuh.common.compliance.req.pci.descp16', {
  defaultMessage:
...
const descp17 = i18n.translate('wazuh.common.compliance.req.pci.descp17', {
  defaultMessage: 'Initialization, stopping, or pausing of the audit logs',
});
const descp18 = i18n.translate('wazuh.common.compliance.req.pci.descp18', {
  defaultMessage: 'Creation and deletion of system level objects',
});
const descp19 = i18n.translate('wazuh.common.compliance.req.pci.descp19', {
  defaultMessage: 'Protect audit trail files from unauthorized modifications',
});
const descp20 = i18n.translate('wazuh.common.compliance.req.pci.descp20', {
  defaultMessage:
    'Use file integrity monitoring or change detection software on logs to ensure that existing log data cannot be changed without generating alerts (although new data being added should not cause an alert).',
});
const descp21 = i18n.translate('wazuh.common.compliance.req.pci.descp21', {
  defaultMessage:
...
const descp22 = i18n.translate('wazuh.common.compliance.req.pci.descp22', {
  defaultMessage:
    'Review logs and security events for all system components to identify anomalies or suspicious activity',
});
const descp23 = i18n.translate('wazuh.common.compliance.req.pci.descp23', {
  defaultMessage:
...
const descp24 = i18n.translate('wazuh.common.compliance.req.pci.descp24', {
  defaultMessage:
...
const descp25 = i18n.translate('wazuh.common.compliance.req.pci.descp25', {
  defaultMessage:
...
const descp26 = i18n.translate('wazuh.common.compliance.req.pci.descp26', {
  defaultMessage:
...
const descp27 = i18n.translate('wazuh.common.compliance.req.pci.descp27', {
  defaultMessage:
