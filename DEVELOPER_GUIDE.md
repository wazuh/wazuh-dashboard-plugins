...
This guide applies to all development within the wazuh-kibana-app project.
...
to all development within the wazuh-kibana-app project. Please make sure to also read them:
...
All filenames and folders should use `kebab-case`.

**Right:** `public/components/health-check/health-check.tsx`

**Wrong:** `public/components/healthCheck/health_check.tsx`

### Do not comment out code

We use GIT (a version control system). If a line of code is no longer needed,
remove it, don't simply comment it out.

### Prettier and Linting

We are gradually moving the wazuh-kibana-app code base over to Prettier. All TypeScript code
...
wazuh-kibana-app uses `snake_case` for the entire API. All urls, paths, query string parameters, values, and bodies should be `snake_case` formatted.
