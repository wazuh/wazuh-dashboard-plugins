...
export const EnrollmentKeyInput = (props: {
    ...
    <>
      <InputForm
            ...
            >
              <EuiFlexItem grow={false}>
                <span className='registerAgentLabels'>
                  <FormattedMessage
                    id='wzFleet.enrollmentAssistant.steps.optionals.enrollmentKey.description'
                    defaultMessage='Assign an enrollment key'
                  />
                </span>
              </EuiFlexItem>
              <EuiFlexItem grow={false}>
                ...
                >
                  <span>
                    <FormattedMessage
                      id='wzFleet.enrollmentAssistant.steps.optionals.enrollmentKey.learn'
                    ...
                    >
                      <FormattedMessage
                        id='wzFleet.enrollmentAssistant.steps.optionals.enrollmentKey.learnAbout'
                        defaultMessage='Enrollment key.'
                      />
                    </EuiLink>
                  </span>
                </EuiPopover>
        ...
        placeholder={i18n.translate(
          'wzFleet.enrollmentAssistant.steps.optionals.enrollmentKey.placeholder',
          {
            defaultMessage: 'Enrollment key',
          },
        )}
