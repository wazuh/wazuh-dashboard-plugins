    ...
    <>
      <InputForm
            ...
            >
              ...
              <EuiFlexItem grow={false}>
                ...
                >
                  <span>
                    <FormattedMessage
                      id='wzFleet.enrollmentAssistant.steps.credentials.password.learn'
                    ...
                    >
                      <FormattedMessage
                        id='wzFleet.enrollmentAssistant.steps.credentials.password.learnAbout'
                        defaultMessage='Server API password.'
                      />
                    </EuiLink>
                  </span>
                </EuiPopover>
        ...
        placeholder={i18n.translate(
          'wzFleet.enrollmentAssistant.steps.credentials.password.placeholder',
          {
            defaultMessage: 'Server API password',
          },
        )}
