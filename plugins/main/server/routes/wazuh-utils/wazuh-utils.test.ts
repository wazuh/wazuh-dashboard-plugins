...
describe.skip('[endpoint] PUT /utils/configuration', () => {
  ...
  it.skip.each`
    ...
    ${'fim_files.pattern'}                         | ${'test space'}                                                  | ${400}             | ${'[request body.pattern]: No whitespaces allowed.'}
    ${'fim_files.pattern'}                         | ${true}                                                          | ${400}             | ${'[request body.pattern]: expected value of type [string] but got [boolean]'}
    ${'fim_files.pattern'}                         | ${'-test'}                                                       | ${400}             | ${"[request body.pattern]: It can't start with: -, _, +, .."}
    ${'fim_files.pattern'}                         | ${'_test'}                                                       | ${400}             | ${"[request body.pattern]: It can't start with: -, _, +, .."}
    ${'fim_files.pattern'}                         | ${'+test'}                                                       | ${400}             | ${"[request body.pattern]: It can't start with: -, _, +, .."}
    ${'fim_files.pattern'}                         | ${'.test'}                                                       | ${400}             | ${"[request body.pattern]: It can't start with: -, _, +, .."}
    ${'fim_files.pattern'}                         | ${'test\\'}                                                      | ${400}             | ${'[request body.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'fim_files.pattern'}                         | ${'test/'}                                                       | ${400}             | ${'[request body.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'fim_files.pattern'}                         | ${'test?'}                                                       | ${400}             | ${'[request body.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'fim_files.pattern'}                         | ${'test"'}                                                       | ${400}             | ${'[request body.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'fim_files.pattern'}                         | ${'test<'}                                                       | ${400}             | ${'[request body.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ...
    ${'fim_files.pattern'}                         | ${'test,'}                                                       | ${400}             | ${'[request body.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'fim_files.pattern'}                         | ${'test#'}                                                       | ${400}             | ${'[request body.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'fim_registries.pattern'}                    | ${'test'}                                                        | ${200}             | ${null}
    ${'fim_registries.pattern'}                    | ${'test*'}                                                       | ${200}             | ${null}
    ${'fim_registries.pattern'}                    | ${''}                                                            | ${400}             | ${'[request body.pattern]: Value can not be empty.'}
    ${'fim_registries.pattern'}                    | ${'test space'}                                                  | ${400}             | ${'[request body.pattern]: No whitespaces allowed.'}
    ${'fim_registries.pattern'}                    | ${true}                                                          | ${400}             | ${'[request body.pattern]: expected value of type [string] but got [boolean]'}
    ${'fim_registries.pattern'}                    | ${'-test'}                                                       | ${400}             | ${"[request body.pattern]: It can't start with: -, _, +, .."}
    ${'fim_registries.pattern'}                    | ${'_test'}                                                       | ${400}             | ${"[request body.pattern]: It can't start with: -, _, +, .."}
    ${'fim_registries.pattern'}                    | ${'+test'}                                                       | ${400}             | ${"[request body.pattern]: It can't start with: -, _, +, .."}
    ${'fim_registries.pattern'}                    | ${'.test'}                                                       | ${400}             | ${"[request body.pattern]: It can't start with: -, _, +, .."}
    ...
    ${'fim_registries.sample.prefix'}              | ${4}                                                             | ${400}             | ${'[request body.alerts.sample.prefix]: expected value of type [string] but got [number]'}
    ${'fim_registries.sample.prefix'}              | ${'-test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'fim_registries.sample.prefix'}              | ${'_test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'fim_registries.sample.prefix'}              | ${'+test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'fim_registries.sample.prefix'}              | ${'.test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'fim_registries.sample.prefix'}              | ${'test\\'}                                                      | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'fim_registries.sample.prefix'}              | ${'test/'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'fim_registries.sample.prefix'}              | ${'test?'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'fim_registries.sample.prefix'}              | ${'test"'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'fim_registries.sample.prefix'}              | ${'test<'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ...
    ${'fim_registries.sample.prefix'}              | ${'test#'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'fim_registries.sample.prefix'}              | ${'test*'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'fim_files.sample.prefix'}                   | ${'test'}                                                        | ${200}             | ${null}
    ${'fim_files.sample.prefix'}                   | ${''}                                                            | ${400}             | ${'[request body.alerts.sample.prefix]: Value can not be empty.'}
    ${'fim_files.sample.prefix'}                   | ${'test space'}                                                  | ${400}             | ${'[request body.alerts.sample.prefix]: No whitespaces allowed.'}
    ${'fim_files.sample.prefix'}                   | ${4}                                                             | ${400}             | ${'[request body.alerts.sample.prefix]: expected value of type [string] but got [number]'}
    ${'fim_files.sample.prefix'}                   | ${'-test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'fim_files.sample.prefix'}                   | ${'_test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'fim_files.sample.prefix'}                   | ${'+test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'fim_files.sample.prefix'}                   | ${'.test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'fim_files.sample.prefix'}                   | ${'test\\'}                                                      | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'fim_files.sample.prefix'}                   | ${'test/'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'fim_files.sample.prefix'}                   | ${'test?'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'fim_files.sample.prefix'}                   | ${'test"'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'fim_files.sample.prefix'}                   | ${'test<'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ...
    ${'system_inventory_system.pattern'}           | ${'test,'}                                                       | ${400}             | ${'[request body.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'system_inventory_system.pattern'}           | ${'test#'}                                                       | ${400}             | ${'[request body.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'system_inventory_hardware.sample.prefix'}   | ${'test'}                                                        | ${200}             | ${null}
    ${'system_inventory_hardware.sample.prefix'}   | ${''}                                                            | ${400}             | ${'[request body.alerts.sample.prefix]: Value can not be empty.'}
    ${'system_inventory_hardware.sample.prefix'}   | ${'test space'}                                                  | ${400}             | ${'[request body.alerts.sample.prefix]: No whitespaces allowed.'}
    ${'system_inventory_hardware.sample.prefix'}   | ${4}                                                             | ${400}             | ${'[request body.alerts.sample.prefix]: expected value of type [string] but got [number]'}
    ${'system_inventory_hardware.sample.prefix'}   | ${'-test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_hardware.sample.prefix'}   | ${'_test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_hardware.sample.prefix'}   | ${'+test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_hardware.sample.prefix'}   | ${'.test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_hardware.sample.prefix'}   | ${'test\\'}                                                      | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_hardware.sample.prefix'}   | ${'test/'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_hardware.sample.prefix'}   | ${'test?'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_hardware.sample.prefix'}   | ${'test"'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_hardware.sample.prefix'}   | ${'test<'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ...
    ${'system_inventory_hardware.sample.prefix'}   | ${'test#'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_hardware.sample.prefix'}   | ${'test*'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_hotfixes.sample.prefix'}   | ${'test'}                                                        | ${200}             | ${null}
    ${'system_inventory_hotfixes.sample.prefix'}   | ${''}                                                            | ${400}             | ${'[request body.alerts.sample.prefix]: Value can not be empty.'}
    ${'system_inventory_hotfixes.sample.prefix'}   | ${'test space'}                                                  | ${400}             | ${'[request body.alerts.sample.prefix]: No whitespaces allowed.'}
    ${'system_inventory_hotfixes.sample.prefix'}   | ${4}                                                             | ${400}             | ${'[request body.alerts.sample.prefix]: expected value of type [string] but got [number]'}
    ${'system_inventory_hotfixes.sample.prefix'}   | ${'-test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_hotfixes.sample.prefix'}   | ${'_test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_hotfixes.sample.prefix'}   | ${'+test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_hotfixes.sample.prefix'}   | ${'.test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_hotfixes.sample.prefix'}   | ${'test\\'}                                                      | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_hotfixes.sample.prefix'}   | ${'test/'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_hotfixes.sample.prefix'}   | ${'test?'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_hotfixes.sample.prefix'}   | ${'test"'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_hotfixes.sample.prefix'}   | ${'test<'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ...
    ${'system_inventory_hotfixes.sample.prefix'}   | ${'test#'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_hotfixes.sample.prefix'}   | ${'test*'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_interfaces.sample.prefix'} | ${'test'}                                                        | ${200}             | ${null}
    ${'system_inventory_interfaces.sample.prefix'} | ${''}                                                            | ${400}             | ${'[request body.alerts.sample.prefix]: Value can not be empty.'}
    ${'system_inventory_interfaces.sample.prefix'} | ${'test space'}                                                  | ${400}             | ${'[request body.alerts.sample.prefix]: No whitespaces allowed.'}
    ${'system_inventory_interfaces.sample.prefix'} | ${4}                                                             | ${400}             | ${'[request body.alerts.sample.prefix]: expected value of type [string] but got [number]'}
    ${'system_inventory_interfaces.sample.prefix'} | ${'-test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_interfaces.sample.prefix'} | ${'_test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_interfaces.sample.prefix'} | ${'+test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_interfaces.sample.prefix'} | ${'.test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_interfaces.sample.prefix'} | ${'test\\'}                                                      | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_interfaces.sample.prefix'} | ${'test/'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_interfaces.sample.prefix'} | ${'test?'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_interfaces.sample.prefix'} | ${'test"'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_interfaces.sample.prefix'} | ${'test<'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ...
    ${'system_inventory_interfaces.sample.prefix'} | ${'test#'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_interfaces.sample.prefix'} | ${'test*'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_networks.sample.prefix'}   | ${'test'}                                                        | ${200}             | ${null}
    ${'system_inventory_networks.sample.prefix'}   | ${''}                                                            | ${400}             | ${'[request body.alerts.sample.prefix]: Value can not be empty.'}
    ${'system_inventory_networks.sample.prefix'}   | ${'test space'}                                                  | ${400}             | ${'[request body.alerts.sample.prefix]: No whitespaces allowed.'}
    ${'system_inventory_networks.sample.prefix'}   | ${4}                                                             | ${400}             | ${'[request body.alerts.sample.prefix]: expected value of type [string] but got [number]'}
    ${'system_inventory_networks.sample.prefix'}   | ${'-test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_networks.sample.prefix'}   | ${'_test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_networks.sample.prefix'}   | ${'+test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_networks.sample.prefix'}   | ${'.test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_networks.sample.prefix'}   | ${'test\\'}                                                      | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_networks.sample.prefix'}   | ${'test/'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_networks.sample.prefix'}   | ${'test?'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_networks.sample.prefix'}   | ${'test"'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_networks.sample.prefix'}   | ${'test<'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ...
    ${'system_inventory_networks.sample.prefix'}   | ${'test#'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_networks.sample.prefix'}   | ${'test*'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_packages.sample.prefix'}   | ${'test'}                                                        | ${200}             | ${null}
    ${'system_inventory_packages.sample.prefix'}   | ${''}                                                            | ${400}             | ${'[request body.alerts.sample.prefix]: Value can not be empty.'}
    ${'system_inventory_packages.sample.prefix'}   | ${'test space'}                                                  | ${400}             | ${'[request body.alerts.sample.prefix]: No whitespaces allowed.'}
    ${'system_inventory_packages.sample.prefix'}   | ${4}                                                             | ${400}             | ${'[request body.alerts.sample.prefix]: expected value of type [string] but got [number]'}
    ${'system_inventory_packages.sample.prefix'}   | ${'-test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_packages.sample.prefix'}   | ${'_test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_packages.sample.prefix'}   | ${'+test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_packages.sample.prefix'}   | ${'.test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_packages.sample.prefix'}   | ${'test\\'}                                                      | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_packages.sample.prefix'}   | ${'test/'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_packages.sample.prefix'}   | ${'test?'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_packages.sample.prefix'}   | ${'test"'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_packages.sample.prefix'}   | ${'test<'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ...
    ${'system_inventory_packages.sample.prefix'}   | ${'test#'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_packages.sample.prefix'}   | ${'test*'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_ports.sample.prefix'}      | ${'test'}                                                        | ${200}             | ${null}
    ${'system_inventory_ports.sample.prefix'}      | ${''}                                                            | ${400}             | ${'[request body.alerts.sample.prefix]: Value can not be empty.'}
    ${'system_inventory_ports.sample.prefix'}      | ${'test space'}                                                  | ${400}             | ${'[request body.alerts.sample.prefix]: No whitespaces allowed.'}
    ${'system_inventory_ports.sample.prefix'}      | ${4}                                                             | ${400}             | ${'[request body.alerts.sample.prefix]: expected value of type [string] but got [number]'}
    ${'system_inventory_ports.sample.prefix'}      | ${'-test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_ports.sample.prefix'}      | ${'_test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_ports.sample.prefix'}      | ${'+test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_ports.sample.prefix'}      | ${'.test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_ports.sample.prefix'}      | ${'test\\'}                                                      | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_ports.sample.prefix'}      | ${'test/'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_ports.sample.prefix'}      | ${'test?'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_ports.sample.prefix'}      | ${'test"'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_ports.sample.prefix'}      | ${'test<'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ...
    ${'system_inventory_ports.sample.prefix'}      | ${'test#'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_ports.sample.prefix'}      | ${'test*'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_processes.sample.prefix'}  | ${'test'}                                                        | ${200}             | ${null}
    ${'system_inventory_processes.sample.prefix'}  | ${''}                                                            | ${400}             | ${'[request body.alerts.sample.prefix]: Value can not be empty.'}
    ${'system_inventory_processes.sample.prefix'}  | ${'test space'}                                                  | ${400}             | ${'[request body.alerts.sample.prefix]: No whitespaces allowed.'}
    ${'system_inventory_processes.sample.prefix'}  | ${4}                                                             | ${400}             | ${'[request body.alerts.sample.prefix]: expected value of type [string] but got [number]'}
    ${'system_inventory_processes.sample.prefix'}  | ${'-test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_processes.sample.prefix'}  | ${'_test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_processes.sample.prefix'}  | ${'+test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_processes.sample.prefix'}  | ${'.test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_processes.sample.prefix'}  | ${'test\\'}                                                      | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_processes.sample.prefix'}  | ${'test/'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_processes.sample.prefix'}  | ${'test?'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_processes.sample.prefix'}  | ${'test"'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_processes.sample.prefix'}  | ${'test<'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ...
    ${'system_inventory_processes.sample.prefix'}  | ${'test#'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_processes.sample.prefix'}  | ${'test*'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_protocols.sample.prefix'}  | ${'test'}                                                        | ${200}             | ${null}
    ${'system_inventory_protocols.sample.prefix'}  | ${''}                                                            | ${400}             | ${'[request body.alerts.sample.prefix]: Value can not be empty.'}
    ${'system_inventory_protocols.sample.prefix'}  | ${'test space'}                                                  | ${400}             | ${'[request body.alerts.sample.prefix]: No whitespaces allowed.'}
    ${'system_inventory_protocols.sample.prefix'}  | ${4}                                                             | ${400}             | ${'[request body.alerts.sample.prefix]: expected value of type [string] but got [number]'}
    ${'system_inventory_protocols.sample.prefix'}  | ${'-test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_protocols.sample.prefix'}  | ${'_test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_protocols.sample.prefix'}  | ${'+test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_protocols.sample.prefix'}  | ${'.test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_protocols.sample.prefix'}  | ${'test\\'}                                                      | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_protocols.sample.prefix'}  | ${'test/'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_protocols.sample.prefix'}  | ${'test?'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_protocols.sample.prefix'}  | ${'test"'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_protocols.sample.prefix'}  | ${'test<'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ...
    ${'system_inventory_protocols.sample.prefix'}  | ${'test#'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_protocols.sample.prefix'}  | ${'test*'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_system.sample.prefix'}     | ${'test'}                                                        | ${200}             | ${null}
    ${'system_inventory_system.sample.prefix'}     | ${''}                                                            | ${400}             | ${'[request body.alerts.sample.prefix]: Value can not be empty.'}
    ${'system_inventory_system.sample.prefix'}     | ${'test space'}                                                  | ${400}             | ${'[request body.alerts.sample.prefix]: No whitespaces allowed.'}
    ${'system_inventory_system.sample.prefix'}     | ${4}                                                             | ${400}             | ${'[request body.alerts.sample.prefix]: expected value of type [string] but got [number]'}
    ${'system_inventory_system.sample.prefix'}     | ${'-test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_system.sample.prefix'}     | ${'_test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_system.sample.prefix'}     | ${'+test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_system.sample.prefix'}     | ${'.test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'system_inventory_system.sample.prefix'}     | ${'test\\'}                                                      | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_system.sample.prefix'}     | ${'test/'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_system.sample.prefix'}     | ${'test?'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_system.sample.prefix'}     | ${'test"'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'system_inventory_system.sample.prefix'}     | ${'test<'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ...
    ${'vulnerabilities.pattern'}                   | ${'test,'}                                                       | ${400}             | ${'[request body.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'vulnerabilities.pattern'}                   | ${'test#'}                                                       | ${400}             | ${'[request body.pattern]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #.'}
    ${'vulnerabilities.sample.prefix'}             | ${'test'}                                                        | ${200}             | ${null}
    ${'vulnerabilities.sample.prefix'}             | ${''}                                                            | ${400}             | ${'[request body.alerts.sample.prefix]: Value can not be empty.'}
    ${'vulnerabilities.sample.prefix'}             | ${'test space'}                                                  | ${400}             | ${'[request body.alerts.sample.prefix]: No whitespaces allowed.'}
    ${'vulnerabilities.sample.prefix'}             | ${4}                                                             | ${400}             | ${'[request body.alerts.sample.prefix]: expected value of type [string] but got [number]'}
    ${'vulnerabilities.sample.prefix'}             | ${'-test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'vulnerabilities.sample.prefix'}             | ${'_test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'vulnerabilities.sample.prefix'}             | ${'+test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'vulnerabilities.sample.prefix'}             | ${'.test'}                                                       | ${400}             | ${"[request body.alerts.sample.prefix]: It can't start with: -, _, +, .."}
    ${'vulnerabilities.sample.prefix'}             | ${'test\\'}                                                      | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'vulnerabilities.sample.prefix'}             | ${'test/'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'vulnerabilities.sample.prefix'}             | ${'test?'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'vulnerabilities.sample.prefix'}             | ${'test"'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
    ${'vulnerabilities.sample.prefix'}             | ${'test<'}                                                       | ${400}             | ${'[request body.alerts.sample.prefix]: It can\'t contain invalid characters: \\, /, ?, ", <, >, |, ,, #, *.'}
