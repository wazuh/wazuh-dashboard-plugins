import { SCA_CHECK_RESULT_COLOR_MAPPING } from './constants';

function formatNumeralForD3(numeralFormat: string): string {
...
export const getDecimalPattern = () => {
  let decimalFormat;
  const pattern = '0,0.[000]%';
  decimalFormat = formatNumeralForD3(pattern);
