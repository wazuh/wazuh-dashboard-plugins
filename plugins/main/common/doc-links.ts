...
export const DOC_LINKS_WITH_FRAGMENTS = {
  ...
  WAZUH_DASHBOARD_TROUBLESHOOTING_WAZUH_API_AND_WAZUH_APP_VERSION_MISMATCH_ERROR_IS_DISPLAYED:
    DOC_LINKS.USER_MANUAL.WAZUH_DASHBOARD.TROUBLESHOOTING +
    '#wazuh-api-and-wazuh-app-version-mismatch-error-is-displayed',
  WAZUH_DASHBOARD_TROUBLESHOOTING_SAVED_OBJECT_FOR_INDEX_PATTERN_NOT_FOUND:
    DOC_LINKS.USER_MANUAL.WAZUH_DASHBOARD.TROUBLESHOOTING +
    '#saved-object-for-index-pattern-not-found',
  CONFIGURING_SCANS_CONFIGURING_VULNERABILITY_DETECTION:
    DOC_LINKS.USER_MANUAL.CAPABILITIES.VULNERABILITY_DETECTION
      .CONFIGURING_SCANS + '#configuring-vulnerability-detection',
} as const;
