...
export const pciRequirementsFile = {
  ...
  '4.1': i18n.translate('wazuh.complianceTable.pciDssRequirements.4_1', {
    defaultMessage:
  ...
  '6.5.5': i18n.translate('wazuh.complianceTable.pciDssRequirements.6_5_5', {
    defaultMessage:
  ...
  '8.3.2': i18n.translate('wazuh.complianceTable.pciDssRequirements.8_3_2', {
    defaultMessage:
  ...
  '8.3.4': i18n.translate('wazuh.complianceTable.pciDssRequirements.8_3_4', {
    defaultMessage:
      'An account is locked out after no more than ten consecutive invalid authentication attempts.',
  }),
  '8.3.6': i18n.translate('wazuh.complianceTable.pciDssRequirements.8_3_6', {
    defaultMessage:
  ...
  '8.3.9': i18n.translate('wazuh.complianceTable.pciDssRequirements.8_3_9', {
    defaultMessage:
  ...
  '10.2.1.3': i18n.translate(
    'wazuh.complianceTable.pciDssRequirements.10_2_1_3',
    { defaultMessage: 'Audit logs capture all access to audit logs.' },
  ),
  '10.2.1.4': i18n.translate(
    'wazuh.complianceTable.pciDssRequirements.10_2_1_4',
    {
      defaultMessage: 'Audit logs capture all invalid logical access attempts.',
    },
  ),
  '10.2.1.5': i18n.translate(
    'wazuh.complianceTable.pciDssRequirements.10_2_1_5',
    {
      defaultMessage:
  ...
  '11.3': i18n.translate('wazuh.complianceTable.pciDssRequirements.11_3', {
    defaultMessage:
      'Internal and external vulnerabilities are identified on a regular basis, prioritized by risk, and addressed.',
  }),
  '11.3.1': i18n.translate('wazuh.complianceTable.pciDssRequirements.11_3_1', {
    defaultMessage:
  ...
  '11.4': i18n.translate('wazuh.complianceTable.pciDssRequirements.11_4', {
    defaultMessage:
      'Internal and external penetration testing is performed regularly, and any exploitable weakness found is corrected.',
  }),
  '11.4.1': i18n.translate('wazuh.complianceTable.pciDssRequirements.11_4_1', {
    defaultMessage:
  ...
  '11.5': i18n.translate('wazuh.complianceTable.pciDssRequirements.11_5', {
    defaultMessage:
      'Network intrusions and unexpected changes to critical files are detected and responded to.',
  }),
  '11.5.1': i18n.translate('wazuh.complianceTable.pciDssRequirements.11_5_1', {
    defaultMessage:
  ...
  '11.5.2': i18n.translate('wazuh.complianceTable.pciDssRequirements.11_5_2', {
    defaultMessage:
  ...
  '12.2': i18n.translate('wazuh.complianceTable.pciDssRequirements.12_2', {
    defaultMessage:
      'Acceptable use policies for end-user technologies are defined and implemented.',
  }),
  '12.3': i18n.translate('wazuh.complianceTable.pciDssRequirements.12_3', {
    defaultMessage:
      'Risks to the cardholder data environment are formally assessed, evaluated, and actively managed.',
  }),
  '12.10': i18n.translate('wazuh.complianceTable.pciDssRequirements.12_10', {
    defaultMessage:
      'Suspected or confirmed security incidents affecting the CDE trigger an immediate response.',
  }),
  '12.10.5': i18n.translate(
    'wazuh.complianceTable.pciDssRequirements.12_10_5',
    {
      defaultMessage:
