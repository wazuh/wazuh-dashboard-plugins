...
export const WAZUH_SETTING_ALERTS_SAMPLE_PREFIX = {settingIndexPattern: 'alerts.sample.prefix', dataSet: 'wazuh-alerts'};
...
export const WAZUH_SAMPLE_DATA_CATEGORIES_TYPE_DATA = {
  [WAZUH_SAMPLE_ALERTS_CATEGORY_SECURITY]: [
    { syscheck: true, settingIndexPattern: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.settingIndexPattern, dataSet: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.dataSet },
    { aws: true, settingIndexPattern: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.settingIndexPattern, dataSet: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.dataSet },
    { office: true, settingIndexPattern: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.settingIndexPattern, dataSet: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.dataSet },
    { gcp: true, settingIndexPattern: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.settingIndexPattern, dataSet: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.dataSet },
    {
      authentication: true,
      settingIndexPattern: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.settingIndexPattern, dataSet: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.dataSet,
    },
    { ssh: true, settingIndexPattern: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.settingIndexPattern, dataSet: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.dataSet },
    {
      apache: true,
      count: 2000,
      settingIndexPattern: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.settingIndexPattern, dataSet: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.dataSet,
    },
    { web: true, settingIndexPattern: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.settingIndexPattern, dataSet: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.dataSet },
    {
      windows: { service_control_manager: true },
      count: 1000,
      settingIndexPattern: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.settingIndexPattern, dataSet: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.dataSet,
    },
    { github: true, settingIndexPattern: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.settingIndexPattern, dataSet: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.dataSet },
  ],
  [WAZUH_SAMPLE_ALERTS_CATEGORY_AUDITING_POLICY_MONITORING]: [
    ...
    { audit: true, settingIndexPattern: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.settingIndexPattern, dataSet: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.dataSet },
    { openscap: true, settingIndexPattern: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.settingIndexPattern, dataSet: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.dataSet },
    { ciscat: true, settingIndexPattern: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.settingIndexPattern, dataSet: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.dataSet },
    {
      virustotal: true,
      settingIndexPattern: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.settingIndexPattern, dataSet: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.dataSet,
    },
    { yara: true, settingIndexPattern: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.settingIndexPattern, dataSet: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.dataSet },
  ],
  [WAZUH_SAMPLE_ALERTS_CATEGORY_THREAT_DETECTION]: [
    ...
    { osquery: true, settingIndexPattern: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.settingIndexPattern, dataSet: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.dataSet },
    { docker: true, settingIndexPattern: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.settingIndexPattern, dataSet: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.dataSet },
    { mitre: true, settingIndexPattern: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.settingIndexPattern, dataSet: WAZUH_SETTING_ALERTS_SAMPLE_PREFIX.dataSet },
  ],
