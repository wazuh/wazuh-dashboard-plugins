export const KnownFields = [
  ...
  {
    name: 'data.ms-graph.activityResult',
    type: 'string',
    esTypes: ['keyword'],
    searchable: true,
    aggregatable: true,
  ...
  {
    name: 'data.ms-graph.activityOperationType',
    type: 'string',
    esTypes: ['keyword'],
    searchable: true,
    aggregatable: true,
...
export const KnownFieldsStatesInventorySystem = [
  ...
  {
    name: 'host.os.distribution.release',
    type: 'string',
    esTypes: ['keyword'],
    searchable: true,
    aggregatable: true,
...
export const KnownFieldsStates = {
  vulnerabilities: KnownFieldsStatesVulnerabilities,
  'inventory-system': KnownFieldsStatesInventorySystem,
  'inventory-hardware': KnownFieldsStatesInventoryHardware,
  'inventory-networks': KnownFieldsStatesInventoryNetworks,
  'fim-files': KnownFieldsStatesFim,
  'fim-registries': KnownFieldsStatesFim,
  // Using same FIM fields for registries as they have similar structure
  'inventory-packages': KnownFieldsStatesVulnerabilities, // Similar to vulnerabilities
  'inventory-ports': KnownFieldsStatesInventoryNetworks, // Similar to networks
  'inventory-processes': KnownFieldsStatesInventorySystem, // Similar to system
  'inventory-protocols': KnownFieldsStatesInventoryNetworks, // Similar to networks
  'inventory-users': KnownFieldsStatesInventorySystem, // Similar to system
  'inventory-groups': KnownFieldsStatesInventorySystem, // Similar to system
  'inventory-services': KnownFieldsStatesInventorySystem, // Similar to system
  'inventory-interfaces': KnownFieldsStatesInventoryNetworks, // Similar to networks
  'inventory-hotfixes': KnownFieldsStatesVulnerabilities, // Similar to vulnerabilities
  'inventory-browser-extensions': KnownFieldsStatesVulnerabilities, // Similar to vulnerabilities
};
