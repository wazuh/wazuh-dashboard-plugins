...
export const CreatePolicyFlyout = ({ closeFlyout }) => {
  ...
  const createPolicy = async () => {
    try {
      const result = await WzRequest.apiReq({i18n.translate('wazuh.security.policies.post', { defaultMessage: 'POST' })}, '/security/policies', {
        name: policyName,
        policy: {
    ...
    <>
      <WzFlyout flyoutProps={{ className: 'wzApp' }} onClose={onClose}>
        <EuiFlyoutHeader hasBorder={false}>
          <EuiTitle size='m'>
            <h2>{i18n.translate('wazuh.security.policies.newpolicy', { defaultMessage: 'New policy' })}</h2>
          </EuiTitle>
        </EuiFlyoutHeader>
        <EuiFlyoutBody>
          <EuiForm component='form' style={{ padding: 24 }}>
            ...
            <EuiSpacer></EuiSpacer>
            <EuiFormRow
              label={i18n.translate('wazuh.security.policies.selectaneffect', { defaultMessage: {i18n.translate('wazuh.security.policies.selectaneffect', { defaultMessage: 'Select an effect' })} })}
