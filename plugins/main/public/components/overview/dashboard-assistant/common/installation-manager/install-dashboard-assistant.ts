...
export const installDashboardAssistantUseCase = (installationOrchestrator: IInstallationManager) => async (request: InstallDashboardAssistantRequest): Promise<InstallDashboardAssistantResponse> => {
  try {
