...
export const ComplianceTableOld = withAgentSupportModule(
...
export const ComplianceTable = withAgentSupportModule(props => {
  ...
  return (
    <>
      ...
      <ComplianceTableOld {...rest} />{' '}
      {/* TODO: this must be removed. It is rendered to compare with the refactor view*/}
    </>
  );
});
