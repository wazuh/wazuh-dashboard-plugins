  ...
  withGuard(
    ...
    () => (
      <EuiEmptyPrompt
        ...
        title={
          <h2>
            {i18n.translate('wazuh.endpointsSummary.noAgentsPrompt.title', {
        ...
        body={
          <p>
            {i18n.translate('wazuh.endpointsSummary.noAgentsPrompt.body', {
        ...
        actions={
          ...
          >
            {i18n.translate(
              'wazuh.endpointsSummary.noAgentsPrompt.deployNewAgent',
