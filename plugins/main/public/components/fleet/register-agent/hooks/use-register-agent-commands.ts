 ...
 */
export function useRegisterAgentCommands<OS extends IOperationSystem, Params extends string>(
  ...
  const commandGenerator = new CommandGenerator(osCommands, optionalParams, wazuhVersion);
