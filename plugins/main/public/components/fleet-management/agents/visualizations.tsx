...
const getVisTopGroups = (indexPatternId: string) => {
    return getPieVis(indexPatternId, 'agent.groups', 'Top 5 Groups', 'top_5_groups');
};

const getVisTopAgentByNode = (indexPatternId: string) => {
    return getPieVis(indexPatternId, 'agent.node_name', 'Top 5 Agents by Node', 'top_5_agents_by_node');
}

const getPieVis = (indexPatternId: string, field: string, title: string, id: string) => {
    return {
        id,
        title,
        type: 'pie',
