...
type DataGridColumnsWidth = DataGridState['columnsWidth'];
...
// retrieve and persist the state of the data grid columns width.
...
export const localStorageColumnsWidthStatePersistenceManager: DataGridStatePersistenceManager<DataGridColumnsWidth> =
  {
    ...
    clearState(moduleId: string) {
      localStorage.removeItem(buildKey(moduleId, KEY_STATE.COLUMN_WIDTH));
    },
  };
