...
describe('localStorageStatePersistenceManager', () => {
  ...
  beforeEach(() => {
    ...
    getItemMock = jest.spyOn(window.localStorage, 'getItem');
    setItemMock = jest.spyOn(window.localStorage, 'setItem');
    removeItemMock = jest.spyOn(window.localStorage, 'removeItem');
