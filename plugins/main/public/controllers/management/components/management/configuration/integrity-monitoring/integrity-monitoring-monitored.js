...
class WzConfigurationIntegrityMonitoringMonitored extends Component {
  ...
  render() {
    ...
    const items =
      ...
      currentConfig.fim.syscheck.directories
        ? settingsListBuilder(currentConfig.fim.syscheck.directories, 'dir')
        : [];
    return (
      <Fragment>
        {currentConfig &&
        ...
        currentConfig.fim.syscheck &&
        currentConfig.fim.syscheck.directories &&
        !currentConfig.fim.syscheck.directories.length &&
        ((currentConfig.fim.syscheck.registry &&
          !currentConfig.fim.syscheck.registry.length) ||
          !currentConfig.fim.syscheck.registry) ? (
        ...
        currentConfig.fim.syscheck &&
        currentConfig.fim.syscheck.directories &&
        currentConfig.fim.syscheck.directories.length > 0 ? (
            ...
            {((agent || {}).os || {}).platform === 'windows' &&
              ...
              currentConfig.fim.syscheck.registry && (
                <Fragment>
                  ...
                  />
                  <EuiBasicTable
                    items={currentConfig.fim.syscheck.registry}
        ...
        {((agent || {}).os || {}).platform === 'windows' &&
          ...
          currentConfig.fim.syscheck &&
          currentConfig.fim.syscheck.registry &&
          currentConfig.fim.syscheck.registry.length > 0 &&
          ((currentConfig.fim.syscheck.directories &&
            !currentConfig.fim.syscheck.directories.length) ||
            !currentConfig.fim.syscheck.directories) && (
            <WzConfigurationSettingsHeader
...
WzConfigurationIntegrityMonitoringMonitored.propTypes = {
