...
/**
 * Guards the navigation placement decided by product direction: the assistant must NOT sit in
 * a dedicated AI-only section, classic or new navigation. There is no top-level `AI` category
 * (or matching new-navigation nav-group category) anywhere. These assertions exist so an edit
 * that reintroduces a dedicated AI category, or drifts the shared category id away from the
 * main plugin's `Home` category, fails loudly here.
 */
