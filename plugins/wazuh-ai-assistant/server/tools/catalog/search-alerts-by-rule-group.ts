 ...
 * 5.0: retargeted to wazuh-findings-v5*; the 4.14 `rule.groups` array was
 * removed and replaced by `rule.tags` (keyword array), matched with a plain `term` (same pattern
 * as search_alerts_by_rule_id.ts). IMPORTANT: the exact `rule.tags` VOCABULARY on findings-v5 is
