...
module.exports = (server, options) => {
    ...
    const loadCredentials = (apiEntries) => {
        ...
        for(let element of filteredApis) {
            ...
            if (apiEntry.error) {
                log('monitoring.js loadCredentials',
                    apiEntry.error || apiEntry
                );
    ...
    const importAppObjects = (id) => {
        ...
        .catch(error => {
            log('monitoring.js importAppObjects',
                error.message || error
            );
    ...
    const configureKibana = () => {
        ...
        .catch(error => {
            log('monitoring.js configureKibana',
                error.message || error
            );
    ...
    const insertDocument = (todayIndex) => {
        ...
        if (agentsArray.length > 0) {
            ...
            .catch(error => {
                log('monitoring.js insertDocument',
                    error.message || error
                );
    ...
    const checkElasticsearchServer  = () => {
        return new Promise(function (resolve, reject) {
            ...
            .catch(error => {
                log('monitoring.js checkElasticsearchServer',
                    error.message || error
                );
                reject(error);
            });
    ...
    const checkKibanaStatus = () => {
        ...
        .catch(error => {
            log('monitoring.js checkKibanaStatus',
                error.message || error
            );
