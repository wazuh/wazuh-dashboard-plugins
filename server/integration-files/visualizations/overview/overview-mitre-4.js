/*
 * Wazuh app - Module for Overview MITRE-4 visualizations
...
export default [
  {
    _id: 'Wazuh-App-Overview-MITRE-4',
    _source: {
  ...
  {
    _id: 'Wazuh-App-Overview-MITRE-4-Alerts-Evolution',
    _source: {
  ...
  {
    _id: 'Wazuh-App-Overview-MITRE-4-Attacks-By-Agent',
    _source: {
  ...
  {
    _id: 'Wazuh-App-Overview-MITRE-4-Attacks-By-Tactic',
    _source: {
  ...
  {
    _id: 'Wazuh-App-Overview-MITRE-4-Top-Tactics-By-Agent',
    _source: {
  ...
  {
    _id: 'Wazuh-App-Overview-MITRE-4-Top-Tactics',
    _source: {
      title: 'Top tactics',
      visState:
