...
export default [
  {
    ...
    _source: {
      ...
      visState:
        '{"title":"Alerts severity over time","type":"metrics","params":{"id":"61ca57f0-469d-11e7-af02-69e470af7417","type":"timeseries","series":[{"id":"61ca57f1-469d-11e7-af02-69e470af7417","color":"rgba(0,156,224,1)","split_mode":"terms","metrics":[{"id":"61ca57f2-469d-11e7-af02-69e470af7417","type":"count"}],"separate_axis":0,"axis_position":"right","split_color_mode":"rainbow","formatter":"number","chart_type":"line","line_width":1,"point_size":1,"fill":0.9,"stacked":"stacked","terms_field":"data.vulnerability.severity","terms_size":"5","terms_order_by":"_count","label":"Alerts"}],"time_field":"@timestamp","index_pattern":"wazuh-alerts","interval":"auto","axis_position":"left","axis_formatter":"number","axis_scale":"normal","show_legend":1,"show_grid":1,"gauge_color_rules":[{"id":"414efe60-3753-11e9-8d90-91d4615ec8c6"}],"gauge_width":10,"gauge_inner_width":10,"gauge_style":"half","bar_color_rules":[{"value":0,"id":"4220f460-3753-11e9-8d90-91d4615ec8c6","bar_color":null}],"drilldown_url":"","filter":"","background_color":null,"background_color_rules":[{"id":"74c34bc0-3753-11e9-8d90-91d4615ec8c6"}]},"aggs":[]}',
      uiStateJSON: '{}',
      description: '',
      version: 1,
