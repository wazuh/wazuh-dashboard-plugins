...
export class WazuhReportingCtrl {
  ...
  private sanitizeKibanaFilters(
    ...
    const agentsFilterStr = agentsFilter
      ...
      if (agentsData.length) {
        ...
        printer.addSimpleTable({
          columns: [
            {
              id: 'id',
              label: i18n.translate('wazuh.server.controllers.reporting.ID', {
                defaultMessage: 'ID',
              }),
            },
            {
              id: 'name',
              label: i18n.translate('wazuh.server.controllers.reporting.Name', {
                defaultMessage: 'Name',
              }),
            },
            {
              id: 'ip',
              label: i18n.translate('wazuh.server.controllers.reporting.IP', {
                defaultMessage: 'IP',
              }),
            },
            {
              ...
              label: i18n.translate(
                'wazuh.server.controllers.reporting.Version',
                {
            ...
            },
            {
              id: 'manager',
              label: i18n.translate(
                'wazuh.server.controllers.reporting.Manager',
                {
            ...
            {
              id: 'os',
              label: i18n.translate('wazuh.server.controllers.reporting.OS', {
                defaultMessage: 'OS',
              }),
            },
            {
              id: 'dateAdd',
              label: i18n.translate(
                'wazuh.server.controllers.reporting.Registrationdate',
                {
            ...
            },
            {
              id: 'lastKeepAlive',
              label: i18n.translate(
                'wazuh.server.controllers.reporting.alive',
                {
        ...
        printer.addContent({
          text: i18n.translate('wazuh.server.controllers.reporting.no groups', {
  ...
  private async extendedInformation(
    ...
    try {
      ...
      if (section === 'overview' && tab === 'vuls') {
        ...
        printer.addList({
          title: {
            text: i18n.translate('wazuh.server.controllers.reporting.Summary', {
        ...
        if (criticalRank && criticalRank.length) {
          printer.addContentWithNewLine({
            text: i18n.translate(
              'wazuh.server.controllers.reporting.critical',
              {
                defaultMessage:
                  'Top 3 agents with critical severity vulnerabilities',
              },
            ),
            style: 'h3',
          });
        ...
        if (highRank && highRank.length) {
          printer.addContentWithNewLine({
            text: i18n.translate('wazuh.server.controllers.reporting.high', {
        ...
        if (mediumRank && mediumRank.length) {
          printer.addContentWithNewLine({
            text: i18n.translate('wazuh.server.controllers.reporting.med', {
              defaultMessage:
        ...
        if (lowRank && lowRank.length) {
          printer.addContentWithNewLine({
            text: i18n.translate('wazuh.server.controllers.reporting.low', {
            ...
            columns: [
              {
                id: 'top',
                label: i18n.translate(
                  'wazuh.server.controllers.reporting.Top',
                  {
                    defaultMessage: 'Top',
                  },
                ),
              },
              {
                id: 'cve',
                label: i18n.translate(
                  'wazuh.server.controllers.reporting.CVE',
                  {
                    defaultMessage: 'CVE',
                  },
                ),
      ...
      if (section === 'overview' && tab === 'general') {
        ...
        if (level15Rank.length) {
          printer.addContent({
            text: i18n.translate(
              'wazuh.server.controllers.reporting.15alerts',
              {
      ...
      if (section === 'overview' && tab === 'pm') {
        ...
        if (top5RootkitsRank && top5RootkitsRank.length) {
          printer
            .addContentWithNewLine({
              text: i18n.translate(
                'wazuh.server.controllers.reporting.commonrookits',
                {
                  defaultMessage:
            ...
            .addContentWithNewLine({
              text: i18n.translate(
                'wazuh.server.controllers.reporting.unauth',
                {
                  defaultMessage:
            ...
            .addSimpleTable({
              ...
              columns: [
                ...
                },
                {
                  id: 'name',
                  label: i18n.translate(
                    'wazuh.server.controllers.reporting.Rootkit',
                    {
                      defaultMessage: 'Rootkit',
                    },
                  ),
                },
              ],
        ...
        !hiddenPids &&
          printer.addContentWithNewLine({
            text: i18n.translate('wazuh.server.controllers.reporting.hidden1', {
        ...
        !hiddenPorts &&
          printer.addContent({
            text: i18n.translate('wazuh.server.controllers.reporting.hidden', {
      ...
      if (['overview', 'agents'].includes(section) && tab === 'pci') {
        ...
        printer.addContentWithNewLine({
          text: i18n.translate('wazuh.server.controllers.reporting.dss', {
              ...
              columns: [
                {
                  id: 'ruleID',
                  label: i18n.translate(
                    'wazuh.server.controllers.reporting.RuleID',
                    {
                ...
                {
                  id: 'ruleDescription',
                  label: i18n.translate('wazuh.server.controllers.reporting.', {
      ...
      if (['overview', 'agents'].includes(section) && tab === 'tsc') {
        ...
        printer.addContentWithNewLine({
          text: i18n.translate('wazuh.server.controllers.reporting.tsc', {
            ...
            printer.addSimpleTable({
              columns: [
                ...
                },
                {
                  id: 'ruleDescription',
                  label: i18n.translate(
                    'wazuh.server.controllers.reporting.Description',
                    {
                      defaultMessage: 'Description',
                    },
                  ),
      ...
      if (['overview', 'agents'].includes(section) && tab === 'gdpr') {
        ...
        printer.addContentWithNewLine({
          text: i18n.translate('wazuh.server.controllers.reporting.gdpr', {
              ...
              columns: [
                {
                  id: 'ruleID',
                  label: i18n.translate(
                    'wazuh.server.controllers.reporting.Rule ID',
                    {
                      defaultMessage: 'Rule ID',
                    },
                  ),
      ...
      if (section === 'overview' && tab === 'audit') {
        ...
        if (auditAgentsNonSuccess && auditAgentsNonSuccess.length) {
          printer.addContent({
            text: i18n.translate('wazuh.server.controllers.reporting.sudo', {
        ...
        if (auditAgentsFailedSyscall && auditAgentsFailedSyscall.length) {
          printer.addSimpleTable({
            columns: [
              {
                id: 'agent',
                label: i18n.translate(
                  'wazuh.server.controllers.reporting.AgentID',
                  {
              ...
              },
              {
                id: 'syscall_id',
                label: i18n.translate(
                  'wazuh.server.controllers.reporting.SyscallID',
                  {
                    defaultMessage: 'Syscall ID',
                  },
                ),
              },
              {
                id: 'syscall_syscall',
                label: i18n.translate(
                  'wazuh.server.controllers.reporting.Syscall',
                  {
            ...
            title: {
              text: i18n.translate(
                'wazuh.server.controllers.reporting.common',
                {
      ...
      if (section === 'overview' && tab === 'fim') {
        ...
        if (rules && rules.length) {
          printer
            ...
            .addSimpleTable({
              ...
              title: {
                text: i18n.translate(
                  'wazuh.server.controllers.reporting.3rules',
                  {
                    defaultMessage:
        ...
        if (agents && agents.length) {
          printer.addContentWithNewLine({
            text: i18n.translate('wazuh.server.controllers.reporting.FIM', {
              defaultMessage: 'Agents with suspicious FIM activity',
            }),
            style: 'h2',
          });
          printer.addContentWithNewLine({
            text: i18n.translate('wazuh.server.controllers.reporting.3agents', {
              defaultMessage:
            ...
            columns: [
              {
                id: 'path',
                label: i18n.translate(
                  'wazuh.server.controllers.reporting.Path',
                  {
                    defaultMessage: 'Path',
                  },
                ),
              },
              {
                id: 'date',
                label: i18n.translate(
                  'wazuh.server.controllers.reporting.Date',
                  {
                    defaultMessage: 'Date',
                  },
                ),
        ...
        lastTenModified &&
          ...
          printer.addSimpleTable({
            ...
            title: i18n.translate(
              'wazuh.server.controllers.reporting.10Files',
              {
                defaultMessage: 'Last 10 modified files',
              },
            ),
          });
      }
        ...
        const requestsSyscollectorLists = [
          {
            ...
            list: {
              title: {
                text: i18n.translate(
                  'wazuh.server.controllers.reporting.Hardwareinformation',
                  {
            ...
            columns: [
              {
                id: 'package',
                label: i18n.translate(
                  'wazuh.server.controllers.reporting.Package',
                  {
              ...
              },
              {
                id: 'severity',
                label: i18n.translate(
                  'wazuh.server.controllers.reporting.Severity',
                  {
      ...
      if (section === 'agents' && tab === 'vuls') {
        const topCriticalPackages =
          await VulnerabilityRequest.topPackagesWithCVE(
            context,
            from,
            to,
            'Critical',
        ...
        if (topCriticalPackages && topCriticalPackages.length) {
          printer.addContentWithNewLine({
            text: i18n.translate(
              'wazuh.server.controllers.reporting.Criticalseverity',
              {
          ...
          printer.addContentWithNewLine({
            text: i18n.translate('wazuh.server.controllers.reporting.review', {
              defaultMessage:
        ...
        if (topHighPackages && topHighPackages.length) {
          ...
          printer.addContentWithNewLine({
            text: i18n.translate('wazuh.server.controllers.reporting.click', {
              defaultMessage:
      ...
      try {
        ...
        if (components['0']) {
          ...
          if (
            ...
            printer.addContent({
              text: i18n.translate(
                'wazuh.server.controllers.reporting.Configurations',
                {
                ...
                if (Array.isArray(config.config[_d])) {
                  ...
                  if (_d === 'localfile') {
                    ...
                    Object.keys(groups).forEach(group => {
                      ...
                      tables.push({
                        title: i18n.translate(
                          'wazuh.server.controllers.reporting.Local files',
                          {
                  ...
                  if (config.config[_d].directories) {
                    ...
                    tables.push({
                      title: i18n.translate(
                        'wazuh.server.controllers.reporting.Monitoreddirectories',
                        {
            ...
            printer.addContent({
              text: i18n.translate(
                'wazuh.server.controllers.reporting.hasNOt',
                {
                  defaultMessage:
                    'A configuration for this group has not yet been set up.',
                },
              ),
              style: { fontSize: 12, color: '#000' },
              margin: [0, 10, 0, 15],
        ...
        try {
          ...
          const agentRequestsInventory = [
                    ...
                    ? [
                        {
                          id: 'name',
                          label: i18n.translate(
                            'wazuh.server.controllers.reporting.Name',
                            {
                              defaultMessage: 'Name',
                            },
                          ),
                        },
                        {
                          id: 'architecture',
                          label: i18n.translate(
                            'wazuh.server.controllers.reporting.Architecture',
                            {
                        ...
                        },
                        {
                          id: 'vendor',
                          label: i18n.translate(
                            'wazuh.server.controllers.reporting.Vendor',
                            {
                  ...
                  agentOs === 'windows'
                    ? [
                        ...
                        },
                        {
                          id: 'cmd',
                          label: i18n.translate(
                            'wazuh.server.controllers.reporting.CMD',
                            {
                              defaultMessage: 'CMD',
                            },
                          ),
                        },
                        {
                          id: 'priority',
                          label: i18n.translate(
                            'wazuh.server.controllers.reporting.Priority',
                            {
                        ...
                        },
                        {
                          id: 'nlwp',
                          label: i18n.translate(
                            'wazuh.server.controllers.reporting.NLWP',
                            {
                              defaultMessage: 'NLWP',
                            },
                          ),
                    ...
                    : [
                        ...
                        },
                        {
                          id: 'euser',
                          label: i18n.translate(
                            'wazuh.server.controllers.reporting.Effectiveuser',
                            {
                        ...
                        },
                        {
                          id: 'state',
                          label: i18n.translate(
                            'wazuh.server.controllers.reporting.State',
                            {
                    ...
                    ? [
                        {
                          id: 'local_ip',
                          label: i18n.translate(
                            'wazuh.server.controllers.reporting.LocalIP',
                            {
                        ...
                        },
                        {
                          id: 'local_port',
                          label: i18n.translate(
                            'wazuh.server.controllers.reporting.Localport',
                            {
                        ...
                        },
                        {
                          id: 'process',
                          label: i18n.translate(
                            'wazuh.server.controllers.reporting.Process',
                            {
                        ...
                        },
                        {
                          id: 'protocol',
                          label: i18n.translate(
                            'wazuh.server.controllers.reporting.Protocol',
                            {
              ...
              table: {
                ...
                columns: [
                  ...
                  },
                  {
                    id: 'mac',
                    label: i18n.translate(
                      'wazuh.server.controllers.reporting.Mac',
                      {
                        defaultMessage: 'Mac',
                      },
                    ),
                  ...
                  },
                  {
                    id: 'mtu',
                    label: i18n.translate(
                      'wazuh.server.controllers.reporting.MTU',
                      {
                        defaultMessage: 'MTU',
                      },
                    ),
                  },
                  {
                    id: 'type',
                    label: i18n.translate(
                      'wazuh.server.controllers.reporting.type',
                      {
                        defaultMessage: 'Type',
                      },
                    ),
            ...
            },
            {
              ...
              table: {
                title: i18n.translate(
                  'wazuh.server.controllers.reporting.Networksettings',
                  {
                ...
                columns: [
                  {
                    id: 'iface',
                    label: i18n.translate(
                      'wazuh.server.controllers.reporting.Interface',
                      {
                  ...
                  },
                  {
                    id: 'address',
                    label: i18n.translate(
                      'wazuh.server.controllers.reporting.address',
                      {
                  ...
                  },
                  {
                    id: 'netmask',
                    label: i18n.translate(
                      'wazuh.server.controllers.reporting.Netmask',
                      {
                  ...
                  },
                  {
                    id: 'broadcast',
                    label: i18n.translate(
                      'wazuh.server.controllers.reporting.Broadcast',
                      {
                ...
                columns: [
                  {
                    id: 'hotfix',
                    label: i18n.translate(
                      'wazuh.server.controllers.reporting.Updatecode',
                      {
