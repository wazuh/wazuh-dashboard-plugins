...
export const networkConnection = {
  "data": {
    ...
    "aws": {
      ...
      "region": "us-east-1",
      "arn": "arn:aws:guardduty:{data.aws.region}:166157441623:detector/cab38390b728c06fb2897dfcebffb79d/finding/06b8d0602d109db1282f9143809f74b4",
...
export const iamPolicyGrantGlobal = {
  "data": {
    "aws": {
      ...
      "source": "macie",
      "url": "https://mt.{data.aws.region}.macie.aws.amazon.com/posts/arn%3Aaws%3Amacie%3A{data.aws.region}%3A166157441623%3Atrigger%2Fb731d9ffb1fe61508d4a478c92efa666%2Falert%2Fd78f0fd0a55ad458799e4c1fb6a0edcd",
      "tags": {
        "value": "Open Permissions,Basic Alert,"
      },
      "alert-arn": "arn:aws:macie:{data.aws.region}:166157441623:trigger/b731d9ffb1fe61508d4a478c92efa666/alert/d78f0fd0a55ad458799e4c1fb6a0ed"
    }
  },
  "rule": {
    "mail": true,
