...
import { ASSETS_BASE_URL_PREFIX_WITH_PUBLIC, WAZUH_MONITORING_DEFAULT_INDICES_REPLICAS, WAZUH_MONITORING_DEFAULT_INDICES_SHARDS, WAZUH_STATISTICS_DEFAULT_INDICES_REPLICAS, WAZUH_STATISTICS_DEFAULT_INDICES_SHARDS } from "../../common/constants";
...
#
#Define the name of the app logo saved in the path ${ASSETS_BASE_URL_PREFIX_WITH_PUBLIC}
#customization.logo.app: ''
#
#Define the name of the sidebar logo saved in the path ${ASSETS_BASE_URL_PREFIX_WITH_PUBLIC}
#customization.logo.sidebar: ''
#
#Define the name of the health-check logo saved in the path ${ASSETS_BASE_URL_PREFIX_WITH_PUBLIC}
#customization.logo.healthcheck: ''
#
#Define the name of the reports logo (.png) saved in the path ${ASSETS_BASE_URL_PREFIX_WITH_PUBLIC}
